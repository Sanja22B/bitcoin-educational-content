...
# Korak bliže digitalnom suverenitetu
...
Nije samo stvar u poznavanju najboljih praksi: radi se o razumevanju onoga što koristite, kako to koristite i šta to znači za vašu bezbednost. Ovaj kurs SCU202 pruža detaljan uvod u tehničke osnove operativnih sistema, uvodi vas u praktičnu upotrebu Linux-a i vodi vas u postavljanju stabilnog, funkcionalnog i otpornog radnog okruženja.
...
Ovaj kurs je namenjen korisnicima srednjeg nivoa koji žele da unaprede svoje veštine u korišćenju digitalnih alata. Zasniva se na praktičnom pristupu, fokusiranom na autonomiju i suverenitet, kako bi se izgradile sigurnije i svesnije svakodnevne IT navike, prateći moto "*Ne veruj, proveri*".
...
Dobrodošli na kurs SCU202, nastavak kursa SCU101, koji će vas dodatno osposobiti u savladavanju IT bezbednosti naglašavajući individualni suverenitet, zaštitu privatnosti i sigurno upravljanje vašim ličnim podacima. Evo pregleda onoga što ćete otkriti tokom kursa SCU202.
...
Kurs počinje kratkim pregledom koncepata obrađenih u SCU101, što će osigurati da ste potpuno u toku sa osnovnim principima neophodnim za pravilno pristupanje onome što sledi.



### Deo 2 - Od klika do terminala: ovladavanje Linuxom
...
Zatim ćete naučiti kako odabrati Linux distribuciju koja najbolje odgovara vašim potrebama i radnom okruženju. Na kraju, napravićete prve korake sa Ubuntuom kroz detaljan vodič za instalaciju i konfiguraciju.
...
Takođe ćete biti obučeni da proverite integritet i autentičnost preuzetog softvera kako biste izbegli infekciju ili kompromitovanje, kao i da efikasno koristite enkripciju za zaštitu vaših ličnih podataka i rezervnih kopija. Na kraju, otkrićete zašto i kako da očistite metapodatke vaših fajlova kako biste zaštitili svoju privatnost na mreži.
...
Danas su veb pregledači svuda u našim svakodnevnim digitalnim životima i često su primarna meta za sajber napade. U ovom odeljku pratimo istoriju pregledača i njihov razvoj.
...
### Deo 5 - Preuzimanje kontrole nad vašim telefonom



Danas su naši pametni telefoni produžeci naših ličnih i profesionalnih života, što čini kontrolu njihove sigurnosti veoma važnom. Detaljno ćemo istražiti različite mobilne operativne sisteme, njihove prednosti i ograničenja, dok otkrivamo open source alternative kako bismo povratili punu suverenost nad vašim uređajem.



Zatim ćete naučiti najbolje prakse za svakodnevnu sigurnost, od ažuriranja do razdvajanja vaših ličnih i profesionalnih podataka. Na kraju, otkrićete sigurne alate za komunikaciju i alternativne open source aplikacije za poboljšanje privatnosti i sigurnosti vašeg telefona.
...
### Deo 6 - Obezbeđivanje vaše lokalne mreže
...
Da biste završili kurs, moći ćete da pokušate da položite završni ispit kako biste dobili sertifikat i proverili svoje razumevanje obrađenih tema.
...
Da li ste spremni da u potpunosti preuzmete kontrolu nad svojom IT sigurnošću, ojačate svoju individualnu suverenost i garantujete svoju online privatnost? Krenimo!
...
Štaviše, ako ste još uvek početnik u radu sa računarima i niste pohađali SCU101, toplo preporučujem da prvo započnete sa tim kursom pre nego što pređete na ovaj. Osnove pokrivene u SCU101 neće biti ponovljene ovde. Stoga se neću vraćati na osnovne bezbednosne prakse, niti na korišćenje VPN-ova, menadžera lozinki ili dvofaktorske autentifikacije. Ipak, svi ovi koncepti su neophodni za savladavanje pre nego što pređete na naprednije upotrebe, koje ćemo pokriti u narednim poglavljima.



Kurs SCU101 bio je uvodni kurs osmišljen da uspostavi čvrstu osnovu u digitalnoj higijeni za početnike i korisnike srednjeg nivoa u IT-u. Njegov cilj bio je poboljšanje svakodnevne sigurnosti, privatnosti i digitalnog suvereniteta.
...
Još jedna dobra praksa obrađena u kursu odnosila se na kolačiće, one male fajlove koji se čuvaju na vašem računaru kada posetite veb-sajtove. Trebalo bi ih redovno brisati ili ograničiti kako biste zaštitili svoju privatnost.



Generalno govoreći, sigurno pretraživanje zahteva određenu dozu opreza: izbegavajte klikanje na nepoznate linkove, izbegavajte sumnjive sajtove i koristite siguran, ažuriran pregledač.
...
SCU101 vas je uveo u koncept VPN-a (Virtuelna Privatna Mreža). U praktičnom smislu, VPN šifrira vaš internet saobraćaj stvarajući siguran tunel između vašeg uređaja i udaljenog servera. Međutim, nisu svi VPN-ovi isti: dajte prednost transparentnim, pouzdanim provajderima koji omogućavaju anonimnu prijavu, kao što su Mullvad, ProtonVPN ili IVPN. Ovi VPN-ovi vam obezbeđuju optimalnu privatnost bez nepotrebnog prikupljanja vaših ličnih podataka.



Štaviše, videli smo da su na javnim Wi-Fi mrežama veze posebno izložene. Zato je korišćenje VPN-a neophodno. Ako ne možete da koristite VPN, povežite se samo na HTTPS sajtove kako biste zaštitili razmenu podataka.
...
### Pažljivo korišćenje vašeg računara
...
SCU101 vas je takođe upozorio da nikada ne priključujete nepoznate USB uređaje u vaš računar, jer mogu sadržati malver koji bi mogao zaraziti vaš sistem.



### Zaštita od sajber napada i upravljanje rezervnim kopijama



Suštinski deo obuke SCU101 bio je razumevanje sajber napada. Virusi se ne pojavljuju sami od sebe: obično zahtevaju vašu nenamernu intervenciju, kao što je preuzimanje zaraženog fajla ili otvaranje lažnog linka u e-mailu.



Jedan od najčešćih napada je phishing, u kojem se šalju lažne poruke kako bi vas podstakli da otkrijete osetljive podatke. Kada se suočavate sa ovim napadima, sistematski proverite pošiljaoca i izbegavajte klikanje na linkove ili otvaranje priloga iz nepoznatih ili sumnjivih izvora.



Još jedna velika pretnja je ransomware, koji blokira vaše podatke šifrovanjem i zahteva otkupninu. Da biste se izborili sa ovim, redovno pravljenje rezervnih kopija vaših podataka je neophodno.
...
Menadžeri lozinki uveliko pojednostavljuju zadatak za vas, jer morate zapamtiti samo jednu glavnu lozinku za sve ostale.
...
Konačno, SCU101 vas je upoznao sa dvofaktorskom autentifikacijom (2FA). Princip se sastoji od izvođenja autentifikacije u dva odvojena koraka: vaša uobičajena lozinka i drugi faktor, kao što je privremeni kod generisan aplikacijom kao što su Google Authenticator ili Authy, ili hardverski ključ kao što je YubiKey.



2FA znatno bolje štiti vaše naloge: čak i ako je vaša lozinka kompromitovana, pristup ostaje nemoguć bez drugog faktora. Budite svesni da su kodovi poslati putem SMS-a ili e-pošte manje sigurni, jer mogu biti presretnuti ili preusmereni.
...
## Linux, Windows, macOS: koji je pravi za vas?
...
Pre nego što pređemo na tehničke detalje o Linuxu u narednim poglavljima, važno je razumeti glavne razlike između tri najčešća sistema: Windows, macOS i GNU/Linux. U ovom poglavlju ćemo proučiti svako rešenje, identifikovati njegove prednosti i ograničenja, a zatim doneti informisani izbor koji odgovara vašim potrebama.
...
U konkretnim terminima, operativni sistem prima, obrađuje i zatim odgovara na zahteve vašeg softvera, koristeći resurse računara što je efikasnije moguće. Upravlja istovremenim izvršavanjem nekoliko programa, kontroliše komponente računara, upravlja konekcijama, omogućava upravljanje fajlovima i osigurava bezbednost podataka kroz mehanizme autorizacije i autentifikacije.
...
Bez operativnog sistema, svaki softverski program bi morao da sadrži sopstveni način komunikacije sa hardverom, što bi učinilo interakciju između različitih programa gotovo nemogućom. Njegova uloga je stoga suštinska.



Upravo tako su radili rani računari. Prvi operativni sistem, GM-NAA I/O, pojavio se tek 1956. godine. Doneo je obradu u serijama, koja je automatizovala upravljanje zadacima. Šezdesete godine su donele pojavu višestrukog programiranja i deljenja vremena sa CTSS (1961) i Multics (1969), što je omogućilo da više korisnika istovremeno komunicira sa istim sistemom. Zatim, sedamdesetih godina, izum Unix-a je revolucionisao računarstvo svojom prenosivošću, upravljanjem multitaskingom i jednostavnošću.
...
### Glavni operativni sistemi i njihov tržišni udeo
...
Prema trenutnim statistikama, Windows i dalje drži većinu instalacija na ličnim računarima, sa tržišnim udelom od oko 71%. Ova dominacija je rezultat kombinacije istorijskih, ekonomskih i tehničkih faktora:





- Od 1990-ih, Windows je bio instaliran po defaultu na većini prodatih računara, što je generisalo ogromnu prepoznatljivost među javnošću. Microsoft je brzo uspostavio veliki broj OEM ugovora (ugovora po kojima proizvođači računara unapred instaliraju Windows), čime je stvorena inercija koju je teško zaustaviti.
...
- Konačno, ovu dominaciju dodatno pojačava i percipirana slika konkurentskih sistema: Linux se često smatra previše tehničkim za širu javnost (i ostaje nepoznat većini), dok se macOS, koji je isključivo povezan sa Apple proizvodima, često doživljava kao skup.



macOS, u međuvremenu, ima tržišni udeo od oko 16%, i obično se bira zbog optimalne integracije sa Apple hardverom. Izbor ovog operativnog sistema je dodatno ojačan u poslednjih nekoliko godina performansama Mac računara, zahvaljujući uvođenju Apple Silicon čipova. Ova velika prekretnica označila je napuštanje Intel x86 procesora u korist ARM arhitekture, koja je efikasnija u pogledu performansi i potrošnje energije.
...
*Izvor april 2025: [StatCounter Global Stats - Udeo operativnih sistema](https://gs.statcounter.com/os-market-share/desktop/worldwide)*



Linux je takođe masovno integrisan u ugrađene uređaje kao što su ruteri, povezani televizori, pametni telefoni (Android je zasnovan na Linux kernelu) i čak u automobilskoj industriji. Windows održava snažno prisustvo u poslovanju, dok macOS preferiraju profesionalci u određenim oblastima.
...
### Windows: jednostavnost korišćenja i kompatibilnost
...
Jedna od ključnih prednosti Windows-a je bogatstvo njegovog softverskog ekosistema: gotovo svi komercijalni programi (kancelarijski paketi, profesionalni softver, video igre i drajveri za hardver) su kompatibilni sa Windows-om. Za korisnike koji traže rešenje spremno za upotrebu sa minimalnom konfiguracijom, ovo može biti logičan izbor.



Međutim, ova pristupačnost dolazi uz cenu. Windows je vlasnički, centralizovani sistem bez javnog izvornog koda. Nije moguća nezavisna verifikacija, što predstavlja jasna ograničenja u smislu transparentnosti i sigurnosti. Štaviše, prikupljanje podataka (telemetrija) je rasprostranjeno u Windows-u i često je aktivirano po defaultu, bez ikakvog stvarnog informisanog pristanka ili mogućnosti kontrole.
...
Po mom mišljenju, Windows zauzima neodređenu centralnu poziciju: može biti siguran, ali manje od Linuxa i macOS-a; omogućava određeni nivo kontrole, ali mnogo manje nego Linux; nije ni toliko moćan kao macOS, niti jednostavan kao Chrome OS ili neki Linux sistemi prilagođeni početnicima. Prosečan je u svim aspektima, bez da je zaista loš u bilo kojoj oblasti (osim privatnosti, po defaultu).
...
Kada je reč o digitalnom suverenitetu i tehničkoj veštini, Windows brzo pokazuje svoja ograničenja. Njegov model se zasniva na neuravnoteženom odnosu između korisnika i izdavača, u korist potonjeg. Za one koji duboko žele da razumeju, personalizuju i osiguraju svoj računar, to nije baš pogodan operativni sistem. Zato se nećemo dalje zadržavati na Windows-u u SCU202.



### macOS: integracija i optimizacija
...
### GNU/Linux: sloboda, kontrola i sigurnost
...
Međutim, Linux takođe predstavlja određenu složenost za početnike. Veliki broj dostupnih Linux distribucija može biti zbunjujući za neupućene korisnike. Slično tome, početno rukovanje sistemom, iako pojednostavljeno kod nekih distribucija, može zahtevati određeno prethodno učenje kako bi se pravilno savladalo, posebno s obzirom na redovnu upotrebu terminala (komandne linije). I upravo o tome se radi u ovom prvom delu SCU202 kursa!



### Koji operativni sistem treba da izaberete?



Vaš izbor će zavisiti prvenstveno od vaših potreba i očekivanja:
...
U narednim poglavljima ovog odeljka o operativnim sistemima, vodiću vas dublje u Linux, upravo zato što omogućava ovo povećano upravljanje vašim ličnim digitalnim okruženjem.
...
Rođenje Linuxa ne može se razumeti bez pomena njegovog direktnog pretka: Unix-a. Kreiran krajem 1960-ih i početkom 1970-ih od strane Kena Tompsona, Denisa Ričija i njihovih kolega u AT&T Bell Labs, Unix je označio značajnu prekretnicu u istoriji operativnih sistema. U početku razvijen u *Assembler*-u, a zatim prepisan u *C* od strane Denisa Ričija 1973. godine, Unix je postavio temelje za radikalno novi model OS-a zasnovan na modularnosti i jednostavnosti.
...
Ovaj pristup se ogleda u osnivačkom principu koji je artikulisao Doug McIlroy:



> Radi jednu stvar i radi je dobro.

Unix se može posmatrati kao evolucija i reakcija na operativni sistem Multics, čiju arhitekturu usvaja. Multics je bio projekat pokrenut 1964. godine, plod saradnje između MIT-a, General Electric-a i AT&T Bell Laboratories-a. Ken Thompson i Dennis Ritchie (tvorci UNIX-a) pomno su pratili projekat Multics sve do 1969. godine, kada se njihova kompanija povukla iz razvoja.



U tom trenutku se pojavio Unix, prvobitno nazvan "*UNICS*" za "*UNiplexed Information and Computing Service*", u direktnoj suprotnosti sa "*MULTiplexed Information and Computing Service*", akronimom za Multics. Ovaj novi pristup zagovara jednostavnost, modularnost i efikasnost, za razliku od prekomerne složenosti Multics-a.



Od 1970-ih godina nadalje, Unix se razvijao u istraživačkom kontekstu, pre nego što je bio široko distribuiran na univerzitetima od 1975. godine, ne najmanje zbog antimonopolskih ograničenja nametnutih AT&T-u. Ovo je pogodovalo njegovom usvajanju u mnogim laboratorijama, kao što je Berkeley, gde je rođena BSD (*Berkeley Software Distribution*) grana. U isto vreme, AT&T je počeo da plasira Unix na tržište 1980-ih, što je dovelo do proliferacije nekompatibilnih vlasničkih verzija (System V, Xenix, SunOS, AIX, Solaris, HP-UX, itd.).
...
*Izvor: Unix history-simple, autor Eraserhead1, Infinity0 i Sav_vas, slika izvedena iz Unix History dijagrama autora Érica Léveneza, [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Unix_history-simple.svg).*



Rastuća fragmentacija između ovih grana (BSD na akademskoj strani, i System V posebno na industrijskoj strani) stvorila je značajnu konfuziju i ograničila interoperabilnost sistema. Da bi pronašla stabilan, prenosiv, besplatan ekvivalent Unix-a, zajednica je pokrenula nekoliko inicijativa, uključujući GNU projekat 1983. godine, nakon čega je usledio razvoj Linux kernela 1991. godine, koji je popunio prazninu nastalu odsustvom slobodnog kernela u GNU ekosistemu. Ovo je bio početak GNU/Linux sistema.
...
Imajući ovo na umu, Stallman je osnovao *Free Software Foundation* (FSF) 1985. godine, organizaciju posvećenu podsticanju i promociji korišćenja i kreiranja slobodnog softvera.
...
- GCC (C kompajler)
- glibc (standardna C biblioteka)
- coreutils (osnovne komande)
- Emacs (porodica tekst editora)
- bash (interpretor komandne linije)
- GDB (Debugger)
...
Neki spoljašnji elementi su takođe integrisani, kao što su X Window System, TeX kompozicioni mehanizam i Mach mikrokernel, korišćen sa GNU Hurd server paketom (zajedno, Mach i Hurd ispunjavaju iste uloge kao klasični Unix kernel, ali u mikrokernel + server arhitekturi). Ovaj projekat zamene kernela bio je ambiciozan, ali veoma složen. Nikada neće postati potpuno funkcionalan, ostavljajući prostor za Linux kernel.
...
Većinu GNU-a razvili su volonteri, neki u svoje slobodno vreme, drugi finansirani ad hoc od strane kompanija, univerziteta ili udruženja. Krajem 1980-ih, FSF je počeo da zapošljava programere kako bi ubrzao rad. Neke kompanije, kao što je Cygnus Solutions (kasnije deo Red Hat-a), igrale su aktivnu ulogu u održavanju i marketingu GNU slobodnog softvera.
...
### Rođenje Linux kernela



Priča o Linux kernelu počinje 1991. godine, sa Linusom Torvaldsom, tada studentom računarstva na Univerzitetu u Helsinkiju, Finska. Nezadovoljan ograničenjima Minixa, minimalističkog Unix operativnog sistema koji je dizajnirao Andrew S. Tanenbaum za obrazovne svrhe, Torvalds je počeo da razvija svoj sopstveni kernel za svoj lični računar, jednostavno sa ciljem da uči kroz praksu. Dana 25. avgusta 1991. godine, javno je najavio svoj projekat na Usenet forumu, skromno navodeći da je još uvek rudimentaran i eksperimentalan. Početkom 1992. godine, verzija 0.12 projekta je objavljena pod GNU GPL slobodnom licencom.
...
Ovo jezgro, prvobitno nazvano Freax, a kasnije preimenovano u Linux (skraćenica od "Linus" i "Unix"), ubrzo je privuklo pažnju drugih strastvenih programera. Međunarodna zajednica spontano se pojavila kako bi doprinela slobodno dostupnom izvornom kodu. Za razliku od GNU-a, Linux je u početku samo jezgro: softverska komponenta odgovorna za upravljanje hardverskim resursima mašine. U kombinaciji sa alatima i aplikacijama koje je već razvio GNU projekat, ovo jezgro konačno pruža potpuno besplatan i funkcionalan operativni sistem. Ova kombinacija se naziva "GNU/Linux" kako bi se naglasila sinergija između dva projekta. U svakodnevnom govoru, međutim, ovaj operativni sistem se obično naziva jednostavno "Linux".
...
→ ***Tux***: maskota i logo Linux kernela, kreiran 1996. godine od strane Larry Ewinga koristeći GIMP softver.



### Filozofija otvorenog koda i slobodnog softvera



Kako je Linux sticao popularnost tokom 1990-ih, pojavila se ideološka debata oko termina "slobodan softver" i "otvoreni kod", ne najmanje zbog dvostrukog značenja termina "*slobodan*".



Dok Richard Stallman i FSF snažno zagovaraju ideju slobodnog softvera zasnovanu na etičkim principima ("*slobodan kao u slobodi*"), drugi akteri favorizuju pragmatičniji, inženjerski orijentisan pristup fokusiran na transparentnost i tehničku efikasnost otvorenog modela. Godine 1998, osnovana je Open Source Initiative (OSI), koja je uvela termin "open source" kako bi se više dopala korporativnom sektoru, naglašavajući ekonomske i tehničke prednosti umesto ideoloških razmatranja.



Richard Stallman otvoreno kritikuje upotrebu termina "open source", smatrajući ga previše neutralnim, čak depolitizovanim. On insistira na terminu "slobodan softver" kako bi naglasio da centralno pitanje nije tehničko, već društveno: pitanje slobode korisnika.
...
Razlika između ova dva pojma stoga leži u osnovnoj motivaciji: pokret slobodnog softvera prvenstveno promoviše filozofiju individualne i kolektivne slobode u vezi sa softverom, dok otvoreni kod prvenstveno ceni tehničku efikasnost, transparentnost i saradnju kao sredstva za bolji proizvod.
...
Kao što smo videli u prethodnom poglavlju, Linuxovo nasleđe danas se proteže daleko izvan jednostavnih ličnih računara: dominira tržištem internet servera, pokreće superračunare, čini tehničku osnovu Android sistema koji pokreće milijarde pametnih telefona širom sveta, i čak je u srcu bezbroj svakodnevnih elektronskih uređaja (ruteri, pametni televizori, povezani objekti, itd.).



GNU/Linux je mnogo više od samo operativnog sistema: to je filozofija, tehnološki, kulturni i društveni pristup zasnovan na otvorenosti, saradnji i digitalnoj slobodi. Ove vrednosti i dalje duboko utiču na način na koji danas zamišljamo, koristimo i delimo tehnologije.
...
Svaka Linux distribucija uključuje :
...
→ **Napomena:** *Rolling release* distribucija integriše najnovije verzije softvera čim postanu dostupne, što rezultira stalno ažuriranim, ali potencijalno manje stabilnim sistemom. Nasuprot tome, *stabilna* distribucija šalje verzije softvera kada se objavi glavna verzija, garantujući veću pouzdanost na račun noviteta.
...
Razumevanje razlika između Linux distribucija je stoga važan korak u odabiru prave za vaše potrebe, veštine i zahteve. To ćemo razmatrati u ovom poglavlju.



### Istorijsko poreklo Linux distribucija



Prve Linux distribucije pojavile su se neposredno nakon objavljivanja Linux kernela od strane Linusa Torvaldsa u septembru 1991. godine. U to vreme, Linux je bio samo kernel: da bi se dobio kompletan sistem, korisnici su morali ručno da sastave različite potrebne komponente (često preuzete iz GNU projekta), što je zahtevalo visok nivo tehničke stručnosti. Instaliranje sistema značilo je kompajliranje kernela, konfigurisanje particija, biranje alata, upravljanje softverskim zavisnostima... Ukratko, složen proces, rezervisan za upućene.
...
Ovi rani napori označili su rođenje Linux distribucija:
...
Razvijen na Univerzitetu u Mančesteru, MCC Interim Linux se smatra prvom Linux distribucijom. Njegov cilj je da pojednostavi instalaciju sistema na standardnom PC-ju. Dolazi u obliku nekoliko disketi i sadrži minimalni skup alata za brzo pokretanje Linux-a.
...
U svojim ranim danima, SLS je bio veliki uspeh, ali su korisnici ubrzo izrazili kritike zbog njegove nestabilnosti i određenih odluka o održavanju. Ovo je podstaklo nekoliko developera da pokrenu paralelne projekte, bilo da poboljšaju SLS ili da ga zamene. Tako je počelo veliko stablo Linux distribucija i njihova segmentacija u porodice.



SLS više ne postoji. Njegova poslednja poznata verzija datira iz kasne 1994. godine.
...
Patrick Volkerding je pokrenuo Slackware donekle slučajno, popravljajući i poboljšavajući greške u SLS-u kao deo školskog projekta na Državnom univerzitetu Minesote. Kroz brojne izmene i optimizacije, njegova modifikovana verzija SLS-a na kraju je postala zaista nezavisna Linux distribucija, verovatno privlačna javnosti razočaranoj ograničenjima SLS-a. Nakon što je dobio odobrenje svog univerziteta, objavio je prvu verziju svoje distribucije pod imenom Slackware 17. jula 1993. godine.
...
Slackware je brzo postao najčešće korišćena Linux distribucija 1990-ih. Njegova jednostavna arhitektura, konfiguracioni shell skriptovi, poštovanje Unix standarda i nedostatak apstrakcije učinili su ga merilom za napredne korisnike koji traže minimalistički, transparentan sistem.



Slackware se i dalje održava danas, što ga čini najstarijom Linux distribucijom koja se još uvek koristi. Takođe je na izvoru brojnih izvedenih distribucija, formirajući prvu veliku porodicu Linux distribucija: Slackware.
...
Otprilike u isto vreme, Ian Murdock je pokrenuo Debian distribuciju, u duhu veoma različitom od tadašnjih praksi, naročito onih koje su utelovljene u distribucijama poput SLS, koje je često održavala jedna osoba. Murdock je zamislio Debian kao strukturirani zajednički projekat, razvijen na otvoren način, u duhu slobodnog softvera i GNU projekta. Za razliku od mnogih drugih Linux distribucija, Debian je nekomercijalna distribucija.
...
*Ian Murdock. Izvor: [Ilya Schurov CC BY-SA 2.0](https://www.flickr.com/photos/ivoyager/2398462112/).*
...
*Debian 1.3 (1997). Izvor: The Linux Distribution Archive*



Rano je projekat formalizovao svoje etičke obaveze objavljivanjem *Debian Social Contract* i Debian Free Software Guidelines (DFSG), kako bi uspostavio jasan statut o slobodi koda i transparentnosti. Sponzorisan neko vreme od strane Free Software Foundation, Debian je zatim postao pravno nezavisan osnivanjem neprofitne organizacije Software in the Public Interest (SPI) 1997. godine.



Debian je tako postao jedan od tehničkih i ideoloških stubova GNU/Linux sveta, osnova iz koje su nastale desetine glavnih distribucija, uključujući Ubuntu, Linux Mint, Kali Linux i Raspberry Pi OS.
...
Marc Ewing je objavio prvu verziju Red Hat Linux-a 1994. godine. Ovo je označilo rađanje distribucije koja će igrati centralnu ulogu u profesionalizaciji Linux-a. Fasciniran Unix univerzumom, Ewing je kreirao strukturiranu, pristupačnu verziju Linux-a, uključujući važan alat: *Red Hat Package Manager* (RPM), koji je standardizovao format softverskih paketa i olakšao njihovu instalaciju, ažuriranje i uklanjanje, posebno u profesionalnim okruženjima. Ovaj format će postati široko prihvaćen standard.
...
*Bob Young i Marc Ewing. Fotograf: Candice C Cusic/AP*



Godine 2003, Red Hat je napravio stratešku podelu: zajednička grana postala je Fedora, inovaciona laboratorija sa brzim razvojnim ciklusom, dok je komercijalna grana transformisana u Red Hat Enterprise Linux (RHEL), sertifikovanu, stabilnu, dugoročnu distribuciju dizajniranu za poslovno-kritične infrastrukture. Od tada, Fedora se koristi kao testno okruženje za tehnologije koje će kasnije biti rigoroznije integrisane u RHEL. Sa ovom organizacijom, Red Hat je uspeo da pomiri agilnost zajednice i industrijsku rigoroznost.
...
Ova porodica je izgrađena oko APT upravitelja paketima i `.deb` formata paketa. Debian se ističe po svom rigoroznom pristupu slobodnom softveru i svom robusnom sistemu upravljanja zavisnostima.
...
Ubuntu, izveden direktno iz Debiana, popularizuje Linux kroz jednostavnost instalacije i korišćenja. Ubuntu ima mnogo zvaničnih varijanti, kao što su Kubuntu (KDE okruženje) i Xubuntu (XFCE). Druge važne distribucije zasnovane na Debianu su Linux Mint (takođe izveden iz Ubuntu-a), Kali Linux (računarska bezbednost) i Raspberry Pi OS za Raspberry Pi mikroračunare.



To je porodica na koju ćemo se sledeće fokusirati, jer okuplja neke od najkonzistentnijih i najpopularnijih Linux distribucija za korišćenje na ličnim računarima.
...
Nekoliko glavnih distribucija direktno je izvedeno iz RHEL-a, sa ciljem da ponude besplatne i kompatibilne alternative, bez troškova komercijalne podrške. Među njima, CentOS je dugo zauzimao važno mesto kao zajednički klon RHEL-a, sve dok Red Hat nije promenio njegovu prirodu 2020. godine u CentOS Stream, međuverziju između Fedore i RHEL-a. Ova odluka dovela je do stvaranja novih forkova kao što su AlmaLinux i Rocky Linux.



Druge važne distribucije iz ove porodice uključuju Oracle Linux, sa specifičnim optimizacijama za cloud okruženja, i ClearOS, distribuciju orijentisanu na SMB sa gotovim serverom i firewall funkcijama.
...
Porodica Arch Linux se ističe filozofijom koja je radikalno suprotna onoj kod gotovih distribucija. Oni su minimalistički i dizajnirani prema principu "*KISS*" ("*Keep It Simple, Stupid*"). Arch Linux pruža osnovni, nepretrpani sistem, koji korisnik mora ručno izgraditi prema svojim potrebama.
...
Slackware je iznjedrio brojne izvedene distribucije, od kojih neke nastoje modernizovati njegovu upotrebu uz očuvanje njegovog duha: Salix, Porteus, Slackel...



Uprkos manjoj zajednici u poređenju sa Debianom ili Red Hat-om, Slackware porodica ostaje istorijska i tehnička referenca u GNU/Linux univerzumu.
...
Izdanak projekta Enoch Linux kreiranog 1999. godine, Gentoo je kreirao Daniel Robbins sa ciljem dizajniranja visoko prilagodljive distribucije, bez unapred kompajliranih binarnih datoteka, optimizovane za hardver korisnika. Preimenovan u Gentoo (po papuanskom pingvinu, jednom od najbržih pingvina), distribucija se zasniva na kompajliranju paketa iz izvornog koda, omogućavajući vrlo precizne optimizacije zahvaljujući korišćenju *Portage*, sistema za upravljanje paketima inspirisanog BSD portovima. Gentoo je namenjen iskusnim korisnicima koji traže performanse, kontrolu i lakoću, po cenu dužeg vremena instalacije i održavanja.
...
Nekoliko derivata je kreirano kako bi se proširila njegova upotreba: Funtoo, Redcore Linux (Sabayon), Calculate Linux, Pentoo, itd.



Konačno, ChromeOS, operativni sistem koji je razvio Google za svoje Chromebookove, prvobitno je izveden iz Gentoo-a, iako se od tada znatno udaljio od njega.
...
Da biste saznali više o porodicama Linux distribucija i vizualizovali grane svake od njih, preporučujem da pogledate ovaj odličan i veoma sveobuhvatan dijagram na Wikimediji: [*Linux Distribution Timeline*](https://upload.wikimedia.org/wikipedia/commons/1/1b/Linux_Distribution_Timeline.svg).
...
Izbor Linux distribucije zavisi od vaših specifičnih potreba, vašeg tehničkog nivoa i nameravane upotrebe. Evo korisnog izbora najčešće korišćenih ili specijalizovanih distribucija, sa njihovim glavnim prednostima i nedostacima.



#### Opšta i pristupačna distribucija
...
Razvijen od strane Canonical-a i lansiran 2004. godine, Ubuntu je jedna od najpopularnijih distribucija na svetu. Baziran na Debian-u, nudi redovan ciklus izdanja, sa stabilnim LTS (*Long Term Support*) verzijama koje se održavaju pet godina. Ubuntu se ističe po svojoj odličnoj kompatibilnosti sa hardverom, velikoj zajednici i obilnoj dokumentaciji, što ga čini veoma sigurnim izborom za početnike. Zapravo, koristićemo Ubuntu za ostatak SCU202 kursa obuke, jer je to solidna ulazna tačka u svet GNU/Linux-a. Ubuntu integriše GNOME radno okruženje po default-u, sa nekoliko specifičnih prilagođavanja.
...
Instalacija je glatka, osnovni softver je unapred instaliran, a "Lite" verzija vam omogućava da pokrenete sistem na starijim mašinama. Neke edicije, kao što je "Pro", nisu besplatne (oko 50 €), ali besplatna verzija je i dalje potpuno funkcionalna. Zorin OS je dobar izbor za one koji traže vizuelno poznato, dobro integrisano okruženje bez ručne konfiguracije.
...
*Izvor: [By Allman - Sopstveni rad, CC BY-SA 4.0](https://commons.wikimedia.org/w/index.php?curid=114760696).*



#### Distribucije srednjeg i visokog učinka
...
Fedora je distribucija podržana od strane Red Hat-a, usmerena ka najnovijim tehnologijama (Wayland, PipeWire, Flatpak...). Koristi RPM format i `dnf` menadžer paketa. Njegov brzi ciklus izdanja znači da je vaš sistem uvek ažuriran, ali ćete morati da pratite redovna ažuriranja. To je idealna distribucija za programere ili tehničke korisnike koji traže moderan sistem.
...
openSUSE je dostupan kao rolling release ili stabilna distribucija. Sadrži YaST alat za konfiguraciju sistema i omogućava svestranu upotrebu sa nekoliko grafičkih okruženja. Zahteva malo više iskustva, ali ostaje robustan za svakodnevnu upotrebu.
...
Debian postoji u nekoliko grana, uključujući *Stable* (veoma pouzdan, ali sa starijim softverom) i *Testing* (ažurniji, ali nešto manje dokazan). Koristi `apt` i poznat je po svojoj rigoroznosti, slobodnoj filozofiji i visokoj kompatibilnosti. Debian je dobar izbor za korisnike koji traže stabilnost, sistem administratore...
...
Baziran na Arch-u, Manjaro čini Arch Linux pristupačnim. Ova distribucija nudi grafičku instalaciju, interne alate i dobru podršku za hardver. Ažuriranja su odložena radi veće stabilnosti. Manjaro je pogodan za korisnike srednjeg nivoa koji traže modernu Arch Linux distribuciju, bez potrebe da sve konfigurišu ručno.
...
Parrot OS je takođe izveden iz Debiana. Nudi okruženje za pentesting, ofanzivnu sigurnost i zaštitu privatnosti. Više svestran od Kalija, ova distribucija je takođe pogodna za laganu svakodnevnu upotrebu, sa unapred integrisanim sigurnosnim alatima.
...
Qubes OS je zasnovan na Fedora sistemu i koristi Xen virtualizacioni sistem za podelu upotrebe na odvojene delove. Svaka aplikacija radi u izolovanoj virtuelnoj mašini. To je visoko bezbedna arhitektura, ali zahteva mnogo resursa i prilično je teška za razumevanje.
...
BlackArch je pentest-orijentisano proširenje za Arch Linux (kao Kali na Debianu). Pruža preko 2800 sigurnosnih alata. To je veoma kompletna distribucija, ali rezervisana za napredne korisnike koji su već upoznati sa Arch univerzumom i kojima su potrebni ovi specijalizovani alati (istraživači sigurnosti, pentesteri...).
...
PureOS je distribucija izvedena iz Debiana koju razvija Purism, potpuno besplatna (odobrena od strane FSF-a). Fokusira se na privatnost, sa isključivo slobodnim softverom i potpunim odsustvom vlasničkih komponenti.
...
- GTK (*GIMP Toolkit*): koristi ga GNOME, XFCE, Cinnamon, MATE...
- Qt: koristi ga KDE Plasma, LXQt...
...
### Pregled glavnih Linux desktop okruženja
...
Ovo je podrazumevano okruženje za Fedora Workstation, Ubuntu i mnoge druge distribucije usmerene na desktop računare.
...
KDE projekat je pokrenut 1996. godine, a prva verzija njegovog desktop okruženja objavljena je 1998. godine. Godine 2014. napravljena je razlika između desktop okruženja i ostalih komponenti projekta. Desktop okruženje je tada nazvano "Plasma".



KDE Plasma je zasnovan na Qt 6, međuplatformskom C++ okviru, i na KDE Frameworks, modularnoj kolekciji biblioteka koje olakšavaju razvoj integrisanih aplikacija. Njegov upravitelj prozora, KWin, takođe deluje kao kompletan Wayland kompozitor: upravlja vizuelnim efektima (zamućenje, transparentnost, tranzicije), deljenjem ekrana uz GPU ubrzanje i multi-touch gestovima putem libinput.
...
KDE Plasma se koristi u mnogim distribucijama, uključujući Kubuntu, openSUSE Tumbleweed, Fedora KDE Spin i Manjaro KDE.
...
Xfce je besplatno, open-source okruženje za radnu površinu koje je 1996. godine kreirao Olivier Fourdan. Njegov početni cilj, koji je i danas važeći, bio je da pruži jednostavnu, laganu i brzu alternativu težim okruženjima za radnu površinu kao što su GNOME ili KDE. Tehnički, Xfce je zasnovan na GTK alatu, što ga u određenim aspektima približava GNOME-u, ali ga takođe razlikuje u svojoj filozofiji.
...
LXQt je rezultat spajanja dva odvojena projekta 2013. godine: LXDE (originalno razvijen sa GTK+ bibliotekom) i Razor-qt (sličnog Qt okruženja). Ovo spajanje je dovelo do stvaranja LXQt-a, sa ciljem ujedinjenja napora uz korišćenje snage i modernosti Qt okvira, koji je bolje prilagođen evoluciji Linux sistema nego GTK+ 2, koji koristi LXDE.
...
U početku, Cinnamon je bio jednostavan Fork GNOME Shell-a, ali se postepeno oslobodio GNOME-a da bi postao potpuno razvijeno radno okruženje, dok je nastavio da se oslanja na GTK biblioteke (posebno GTK 3).
...
Tehnički, MATE je zasnovan na GTK 3 bibliotekama (nakon što je dugo koristio GTK 2), i održava modularnu strukturu: upravitelj datoteka (Caja), kontrolna tabla, terminal, uređivač teksta... Svi ovi komponenti su forkovi GNOME 2 alata, kontinuirano ažurirani kako bi ostali kompatibilni sa modernim sistemima.
...
Odabir vašeg GNU/Linux okruženja radne površine nije trivijalna stvar: ono određuje korisničko iskustvo, performanse sistema i kompatibilnost softvera. Svako DE se zasniva na tehničkim izborima (biblioteke, arhitektura, upravitelj prozora...) koji utiču na njegov izgled, ponašanje, performanse, pa čak i na hardverske zahteve. Evo glavnih kriterijuma koje treba razmotriti prilikom donošenja informisane odluke.
...
#### Estetske i ergonomske preferencije
...
Glavna upotreba računara će takođe uticati na vaš izbor:
...
#### Kompatibilnost sa izabranom distribucijom



Svaka GNU/Linux distribucija favorizuje podrazumevano radno okruženje, koje je često bolje integrisano, bolje testirano, dolazi sa posvećenim alatima i instalirano je po defaultu. Uvek je moguće instalirati drugo radno okruženje, ali to može dovesti do dupliranja softvera, konflikata u konfiguraciji ili manje konzistentnog korisničkog iskustva. Vaš izbor radnog okruženja može stoga biti pod uticajem vaše Linux distribucije, ili, obrnuto, vaša preferencija za specifično radno okruženje može usmeriti vaš izbor distribucije.



Imajte na umu da neke distribucije, bilo da ih održava projektni tim ili spoljni saradnici, uključuju radno okruženje koje se razlikuje od podrazumevanog (npr. Kubuntu, Lubuntu, Xubuntu...).



Evo su radna okruženja glavnih distribucija:
...
- Linux Mint → Cinnamon (main edition), ali i MATE i Xfce
...
- Fedora → GNOME (glavno izdanje), ali nudi nekoliko zvaničnih Spins:
 ...
 - Fedora SoaS, i3, itd. → specifična okruženja





- Debian → GNOME (podrazumevano), izbor KDE, Xfce, LXQt, Cinnamon, MATE tokom instalacije





- Manjaro → KDE Plasma, GNOME ili Xfce u zavisnosti od izdanja; dostupna izdanja zajednice sa Cinnamon, MATE, LXQt, i3, itd.





- Zorin OS → Zorin Desktop, baziran na GNOME (Core verzija) i Xfce (Lite verzija)
...
- openSUSE → izaberite prilikom instalacije između KDE Plasma (najintegrisanije izdanje), GNOME, Xfce, MATE, itd.





- Arch Linux → ne pruža podrazumevano okruženje, tako da treba da instalirate ono po vašem izboru





- Kali Linux → Xfce (podrazumevano od 2019), takođe nudi KDE, GNOME, i3, MATE, itd.





- Parrot OS → MATE (podrazumevano), alternativna verzija sa KDE Plasma
...
- Whonix → KDE Plasma (glavna verzija), alternativa dostupna sa Xfce
...
Danas je Ubuntu jedan od najpristupačnijih ulaza u GNU/Linux: uglađeno GNOME okruženje, opsežni repozitoriji, brze sigurnosne nadogradnje i velika zajednica. Zato sam odlučio da predstavim ovu distribuciju.
...
Pre nego što možete koristiti Ubuntu, potrebno je da ga instalirate na svoj računar. Ovaj korak može delovati zastrašujuće ako to nikada ranije niste radili, ali danas je to vrlo lako uraditi.



Nekoliko scenarija je moguće, u zavisnosti od stanja vašeg trenutnog računara:




- Ako imate računar sa unapred instaliranim Windows-om, možete ili instalirati Ubuntu pored Windows-a (*"dual boot"*), ili potpuno zameniti vaš trenutni sistem. Ako se odlučite za *dual boot*, možete izabrati koji operativni sistem želite pokrenuti pri svakom pokretanju. Ovo je rešenje po izboru ako jednostavno želite testirati Ubuntu dok zadržavate pristup Windows-u.
- Ako imate novu mašinu bez operativnog sistema, možete direktno instalirati Ubuntu kao glavni sistem



U svim slučajevima, proces instalacije prati iste tehničke principe, koje ćemo uskoro otkriti.
...
Datoteka za instalaciju Ubuntu-a dolazi u obliku ISO slike, datoteke koja sadrži sve što vam je potrebno za pokretanje i instalaciju sistema. Da biste je preuzeli, [posetite zvaničnu veb stranicu](https://ubuntu.com/download/desktop).
...
Postoje 2 verzije Ubuntu Desktop:
...
Glavna razlika između LTS verzije i ne-LTS verzije Ubuntu-a je trajanje podrške i stabilnost. LTS verzija je podržana 5 godina. Nasuprot tome, ne-LTS verzija je podržana samo 9 meseci, tako da je potrebno redovno nadograđivati sistem. S druge strane, najnovija ne-LTS verzija uključuje sve nove funkcije. Preporučujem LTS verziju ako tek počinjete, jer je stabilnija i zahteva manje velikih ažuriranja. Međutim, možete se odlučiti za najnoviju ne-LTS verziju ako želite: to neće imati uticaja na ostatak programa.



Jednostavno kliknite na dugme "*Download*" da preuzmete Ubuntu ISO sliku.
...
Da biste instalirali Ubuntu na vaš računar, potrebno je da ISO sliku učinite butabilnom sa USB ključa. Ovaj ključ će služiti kao instalacioni medij.



Priključite USB fleš disk od najmanje 8 GB (pazite, njegov sadržaj će biti izbrisan), zatim koristite alat kao što je [BalenaEtcher](https://www.balena.io/etcher) da kreirate butabilni medijum iz ISO slike. Jednostavno izaberite ISO fajl, USB ključ, i kliknite na "*Flash*".
...
U meniju za pokretanje izaberite USB ključ (može se pojaviti pod imenom proizvođača ključa ili kao "USB"). Zatim izaberite "*Try or Install Ubuntu*". Računar će se zatim pokrenuti u Ubuntu "live" režimu: ovo vam omogućava da testirate sistem bez modifikovanja bilo čega, ili da direktno pokrenete instalaciju.
...
Instalater će predložiti:




- izaberite svoj jezik i vremensku zonu
- poveži se na Wi-Fi mrežu
- izaberite tip instalacije (podrazumevana ili proširena) u zavisnosti od toga da li želite minimalan sistem ili onaj sa mnogo unapred instaliranih aplikacija
- da li da instalirate softver treće strane (grafički drajveri, kodeci, itd.) ili ne
...
Kada pokrenete Ubuntu, čarobnjak za instalaciju vodi vas korak po korak. Pratite svaki korak i izaberite opcije koje vam najviše odgovaraju. Najvažniji korak se odnosi na tip instalacije. U zavisnosti od vaše situacije, postoje tri moguća slučaja:
...
Izaberite ovu opciju ako želite zadržati Windows za određene softverske aplikacije (npr. video igre) dok istražujete Linux.



Da biste to uradili kako treba, preporučujem da prvo kreirate nealokovanu particiju na disku po vašem izboru u Windows-u, a zatim ručno izaberete ovu particiju prilikom instalacije Ubuntu-a. Da biste to uradili, otvorite Disk Manager u Windows-u, kliknite desnim tasterom miša na disk u pitanju i izaberite "*Reduce Volume*". Zatim navedite veličinu koju želite da rezervišete za Ubuntu (preporučujem minimum od 80 GB za udobno korišćenje).
...
Ako želite koristiti samo Ubuntu, možete odabrati potpuno brisanje diska:




- Ova opcija briše sve postojeće podatke, uključujući Windows
- Ubuntu će tada postati jedini sistem instaliran na mašini



Izaberite ovu opciju samo ako želite da pređete 100% na GNU/Linux. Ne zaboravite da napravite rezervnu kopiju svojih Windows podataka pre nego što ih potpuno izbrišete.





- Instalacija na praznom računaru
...
Zatim će vam biti zatraženo da postavite korisnički nalog (ime, lozinka, ime mašine). Izaberite jaku lozinku: omogućiće vam da se prijavite na sistem, instalirate softver ili promenite važna podešavanja.



Za više informacija o Ubuntu instalateru, možete takođe pogledati ovaj vodič:
...
Čestitamo, sada imate kompletan GNU/Linux sistem!
...
Čim čarobnjak za instalaciju završi, prijavite se sa novim korisnikom i otvorite terminal:
...
ISO slike sadrže zamrznute pakete nekoliko nedelja pre izdavanja, tako da uvek prvo sinhronizujte indekse i primenite zakrpe:
...
Prva komanda ažurira lokalnu listu paketa, preuzima nove verzije i instalira ih; druga uklanja sve zavisnosti koje više nisu potrebne.



→ Komanda `sudo` izvršava radnju sa administratorskim pravima i traži vašu lozinku za potvrdu.
...
Zatim možete ponovo pokrenuti računar:
...
#### Repozitorijumi softvera i kanali: razumevanje odakle softver dolazi



Pod Ubuntuom, softver se instalira i ažurira putem sistema zvaničnih repozitorijuma. Repozitorijum je server koji sadrži hiljade softverskih paketa (programa, biblioteka, drajvera...), svi organizovani prema preciznim pravilima. Ovi paketi su verifikovani, potpisani i distribuirani automatski putem `apt` menadžera paketa.



Svako spremište je podeljeno na sekcije. Po defaultu, Ubuntu aktivira četiri glavne sekcije:
...
Svaka komponenta se zatim može razložiti na nekoliko kanala ili grana: `release`, `security`, `updates`, `backports`, itd., u zavisnosti od prirode ažuriranja.



### Prvi koraci na komandnoj liniji
...
Korišćenje terminala omogućava vam da direktno manipulišete fajlovima, precizno konfigurišete sistem, upravljate paketima, automatizujete zadatke ili dijagnostikujete probleme. Evo izbora osnovnih komandi koje će vam biti potrebne za početak.





- Prikaži trenutni direktorijum:
...
Ova komanda prikazuje apsolutnu putanju direktorijuma u kojem se trenutno nalazite. Veoma korisno ako želite da pratite svoju lokaciju u stablu direktorijuma.
...
- Navedite sadržaj direktorijuma
...
Ova komanda prikazuje fajlove i direktorijume u trenutnom direktorijumu u detaljnom formatu:




- `-l`: "*long*" mod, koji prikazuje dozvole, veličinu, korisnika, datum...
- `-a`: takođe prikazuje skrivene fajlove (one koji počinju tačkom).
- `-h`: "*čoveku čitljivo*", prikazuje veličine u čitljivom formatu (KB, MB...).
...
Prikazuje strukturu stabla diskova i particija povezanih sa vašim sistemom. Ovo je veoma korisno za identifikaciju USB drajva, na primer.
...
`cd` označava "*change directory*". Ovo vam omogućava da se krećete kroz strukturu direktorijuma. Na primer, sa komandom `cd Music`, bićete u direktorijumu `/Music`.
...
- `cd ~`: vraća se u početni direktorijum.
- `cd -`: vraća se u prethodni direktorijum.
...
Da biste kreirali novi direktorijum unutar trenutnog, koristite komandu:
...
Da biste kopirali datoteku, koristite komandu `cp`, nakon koje sledi naziv datoteke (morate biti u direktorijumu gde se datoteka nalazi), zatim putanju do odredišnog direktorijuma.
...
- Premještanje ili preimenovanje datoteke:
...
- Brisanje datoteke ili direktorijuma:
...
Upozorenje: ova komanda ne premešta fajlove u korpu za otpatke.
...
- `-r`: rekurzivno brisanje (za direktorijume).
- `-f`: forsira brisanje bez potvrde (opasno).
...
Da biste očistili terminal i započeli s praznim ekranom, upišite:
...
- Izvrši komandu kao administrator:
...
Ovo otvara puni terminal sa root privilegijama. Koristite sa oprezom i nikada na duži vremenski period.
...
Komanda `man` (*manual*) otvara kompletnu dokumentaciju komande. Krećite se pomoću strelica i izađite sa `q`.
...
Ove početne komande su sve što vam je potrebno za izvođenje većine osnovnih operacija u vašem terminalu. Uz malo vežbe, steći ćete autonomiju i brzinu.



U sledećim odeljcima, detaljnije ćemo pogledati kako koristiti terminal za upravljanje sistemom, paketima i sigurnosnim alatima.



### Upravljanje paketima: APT, Snap i Flatpak
...
#### APT: Debian-ova izvorna metoda



APT (*Advanced Package Tool*) je glavni upravitelj paketa za Ubuntu. Rukuje paketima u `.deb` formatu, iz zvaničnih repozitorijuma. Svaki paket sadrži softver, zavisnosti i metapodatke. Pogledajmo neke osnovne komande, koristeći GIMP uređivač slika kao primer.
...
Da biste instalirali paket i sve njegove zavisnosti:
...
Još jednostavnije: možete direktno upisati naziv softvera u terminal (u ovom slučaju, "gimp") da biste ga otvorili.
...
Da biste uklonili softver, možete koristiti sledeću komandu (zamenjujući "gimp" imenom softvera koji želite da deinstalirate):
...
Takođe možete dodati `--purge` svojoj komandi da obrišete konfiguracione fajlove povezane sa softverom:
...
Da biste ažurirali bazu podataka dostupnih paketa (`update`) i instalirali najnovije verzije (`upgrade`), možete pokrenuti sledeće dve komande:
...
Da biste ažurirali sve instalirane Snap pakete:
...
→ Snap aplikacije su instalirane u direktorijumu `/var/snap` i montirane kao zasebni fajl sistemi.



#### Flatpak: modularna alternativa



Flatpak je još jedan univerzalni format paketa, razvijen od strane zajednice (Red Hat, GNOME...). Cilj mu je prevazilaženje ograničenja tradicionalnih formata, dok nudi bolje upravljanje dozvolama nego Snap. Svaka aplikacija radi u sandbox okruženju, ali sa finijom granularnošću kontrole.
...
Da biste instalirali aplikaciju putem Flatpak-a, koristite sledeću komandu (u ovom primeru, za instalaciju VLC softvera):
...
#### Proveri status automatske usluge



Da biste bili sigurni da je ovaj mehanizam aktivan:
...
Trebalo bi da vidite izlaz koji pokazuje da je usluga `active (running)`.
...
Ako to nije slučaj, možete ga aktivirati ručno:
...
→ **Imajte na umu:** `unattended-upgrades` je ograničen na sigurnosne pakete iz `security` repozitorijuma. Stoga se ne primenjuje na standardna ažuriranja softvera, koja ćete morati da izvršite ručno.



#### Ručno ažuriraj ceo sistem



Čak i ako se kritične zakrpe automatski instaliraju, važno je redovno pokretati ručno ažuriranje kako biste iskoristili najnovije verzije softvera i komponenti koje nisu pokrivene `unattended-upgrades`. Da biste to uradili, pokrenite komandu:
...
- `apt update` sinhronizuje listu dostupnih paketa
- `apt full-upgrade` instalira nove verzije, čak i ako to znači modifikaciju određenih zavisnosti (za razliku od `upgrade`, koji je konzervativniji)
...
Nakon ažuriranja, možete očistiti nepotrebne fajlove pomoću:
...
Ova komanda uklanja zastarele pakete i pridružene konfiguracione fajlove.
...
#### Ponovno pokretanje nakon određenih ažuriranja



Neke kritične nadogradnje, kao što su one za Linux kernel ili libc (standardna biblioteka jezika C koju koristi većina programa), stupaju na snagu tek nakon ponovnog pokretanja vašeg računara. Da biste saznali da li je preporučljivo ponovno pokretanje, instalirajte alat `needrestart`:
...
Održavanje vašeg sistema i softvera ažurnim je suštinski refleks kada je u pitanju bezbednost računara. Ažuran Linux sistem je garancija stabilnosti, bezbednosti i performansi.
...
Firewall je sigurnosni alat koji kontroliše dolazne i odlazne mrežne veze računara. Na Ubuntu-u, koristićete ga za filtriranje saobraćaja kako biste autorizovali samo legitimne komunikacije i blokirali potencijalno zlonamerne. Ovo sprečava nepozvane spoljašnje upade, na primer, kako bi dodatno zaštitili vaše podatke i vaš sistem.



Čim instalirate Ubuntu, obezbeđivanje mrežnih komunikacija vašeg računara je važan korak. Ubuntu uključuje standardni firewall: UFW (*Uncomplicated Firewall*). Omogućava vam upravljanje dolaznim i odlaznim vezama sa preciznom kontrolom, bez potrebe za ručnim pisanjem složenih pravila.
...
Podrazumevano, UFW je instaliran, ali neaktivan. Da biste ga aktivirali:
...
Jednom aktiviran, možete proveriti njegov status i trenutna pravila sa:
...
Podrazumevano, UFW usvaja strategiju odbijanja netraženih dolaznih veza dok omogućava odlazni saobraćaj, što je dobra bezbednosna/funkcionalna kompromisna opcija za višenamensku ličnu mašinu.
...
Ako treba da omogućite udaljeni pristup servisu (kao što je SSH server), morate ga eksplicitno autorizovati:
...
- `22` je podrazumevani port za SSH uslugu
- `tcp` je protokol koji se koristi
- Opcija `comment` omogućava vam da dodate čitljivu napomenu kako biste kasnije lakše protumačili pravila.



Možete proveriti pravilo sa:
...
#### Definiši pravila po IP opsegu (lokalna upotreba)
...
Ovo omogućava TCP konekcije na portu 6881 samo sa podmreže `192.168.1.0/24` (obično vaša kućna Wi-Fi mreža).
...
### Internet konekcija i upravljanje mrežom
...
Ovaj intuitivni način upravljanja pokriva većinu klasičnih potreba ličnog računara.
...
#### Korišćenje terminala sa nmcli



Za rešavanje problema ili daljinski pristup, komanda `nmcli` omogućava vam da manipulišete *NetworkManager*-om iz komandne linije.
...
### Instaliranje osnovnih aplikacija
...
Zatim, da biste sprečili sistem da se automatski vrati na Snap verziju tokom ažuriranja:
...
Ovo zamrzava trenutno instaliranu verziju `.deb`. Nastaviće da se ažurira, ali će ostati u ovom formatu.
...
Thunderbird je vodeći open-source e-mail klijent, takođe razvijen od strane Mozille. Podržava IMAP/POP naloge, kalendare, ekstenzije i OpenPGP enkripciju.
...
LibreOffice je najkompletniji besplatni office paket. Nudi alternative za Word, Excel i PowerPoint, sa odličnom kompatibilnošću sa Microsoft Office formatima (.docx, .xlsx, .pptx).
...
Ako želite fokusiraniju instalaciju:
...
Ova tri paketa pokrivaju osnovne stvari: obradu teksta, tabelarne proračune i prezentacije.
...
VLC je univerzalni medija plejer, sposoban da reprodukuje većinu audio/video formata bez dodatnih kodeka:
...
Za retuširanje fotografija i crtanje vektora, dostupne su dve open source reference:
...
GIMP je napredni softver za uređivanje fotografija, uporediv sa Adobe Photoshop-om, a Inkscape je softver za vektorsku grafiku, uporediv sa Adobe Illustrator-om.



Za uređivanje videa možete instalirati Kdenlive, koji je sveobuhvatan, intuitivan i pogodan za početnike i napredne korisnike:
...
Za uređivanje zvuka, tu je Audacity
...
Za snimanje ekrana, strimovanje ili kreiranje sadržaja uživo, tu je OBS Studio.
...
Ako ste programer, možete instalirati osnovno razvojno okruženje za C/C++, Git i druge alate pomoću ove komande:
...
- Koristite komandu `sudo` samo kada je strogo neophodno. Ova komanda privremeno podiže vaša prava kako biste izvršili akciju kao administrator. Greška sa `sudo` (npr. `rm -rf`) može uticati na ceo sistem. Takođe, treba izbegavati prelazak u root režim (`sudo -i`) za duge sesije, osim ako nije izuzetno neophodno;





- Iako Ubuntu automatski primenjuje određene bezbednosne zakrpe putem usluge `unattended-upgrades`, ovo ne pokriva sav softver. Trebalo bi redovno da izvršavate potpuno ručno ažuriranje:
...
Sa ovim poglavljem o osnovama Ubuntu-a, sada imate funkcionalno, dosledno Linux okruženje pogodno za svakodnevnu upotrebu. Znate kako da instalirate softver, konfigurišete svoju mrežu, održavate sistem ažurnim i intervenišete putem komandne linije terminala.



Ova tehnička autonomija je suštinska osnova za samouvereno pristupanje ostatku ovog kursa. U sledećem delu, detaljnije ćemo razmotriti sigurnosne mehanizme vaše radne stanice i sprovesti prve konkretne mere za jačanje njene otpornosti.
...
## Autentifikacija i particionisanje
...
### Zaštitite pristup svom računaru



Zaštita fizičkog i softverskog pristupa vašem računaru je osnova njegove sigurnosti. Neosigurana mašina može lako postati ulazna tačka za napadača ili omogućiti curenje osetljivih podataka, čak i bez internet konekcije. Bez obzira da li koristite Windows, macOS ili Linux, postoji nekoliko osnovnih mera koje treba preduzeti kako biste ograničili rizik od neovlašćenog pristupa.
...
Lozinka sesije (ona koju unosite pri pokretanju ili buđenju iz stanja mirovanja) je prva barijera protiv pokušaja upada. Ona sprečava treću stranu da pristupi vašim podacima ili manipuliše vašim sistemom ako je vaš uređaj ukraden ili ostavljen bez nadzora.



Ova lozinka mora biti jaka:
...
*Izvor: [Hive Systems](https://www.hivesystems.com/)*



Složena lozinka će sigurno biti teška za pamćenje. Stoga preporučujem korišćenje menadžera lozinki kao što su Bitwarden ili KeePass.
...
Bezbednost vašeg računara ne počinje tek kada se operativni sistem pokrene, već od samog početka. Pre nego što Windows, Linux ili macOS uopšte počnu sa radom, program integrisan u matičnu ploču, nazvan BIOS ili UEFI, u zavisnosti od generacije vašeg uređaja, preuzima kontrolu nad mašinom kako bi inicijalizovao hardver i pokrenuo proces podizanja sistema.



BIOS (*Basic Input/Output System*) je prethodnik UEFI (*Unified Extensible Firmware Interface*). Danas je UEFI standard na svim modernim računarima.
...
**Upozorenje:** ako izgubite ovu lozinku, bićete blokirani i moraćete da resetujete matičnu ploču. Zato obavezno čuvajte ovu lozinku u menadžeru lozinki ili na sigurnom fizičkom mestu.



Pored toga, omogućite funkciju "Secure Boot" ako je dostupna i još nije aktivna. Ovaj mehanizam sprečava izvršavanje nepotpisanog ili izmenjenog koda prilikom pokretanja sistema. Dizajniran je da blokira bootkit-ove i rootkit-ove, tipove malvera koji inficiraju pokretanje računara, čak i pre nego što se operativni sistem pokrene.



Osiguranje UEFI-ja je često zanemarena, ali apsolutno ključna mera za zaštitu vašeg računara od naprednih napada. To je jedan od retkih bedema protiv fizičkog upada ili manipulacije pre pokretanja sistema.
...
Da biste ograničili rizik od fizičke krađe, možete opremiti desktop računar fizičkim sistemom zaključavanja. Većina profesionalnih računara ima Kensington sigurnosni port, koji omogućava pričvršćivanje čeličnog kabla za fiksni komad nameštaja. Varijante su dostupne i za laptopove. Ovi uređaji, naravno, ne nude apsolutnu zaštitu od krađe, ali su dovoljni da odvrate oportunističke napade.
...
Pored toga, uvek isključite svoj uređaj kada ste udaljeni od njega, posebno u nesigurnom okruženju. Za razliku od jednostavnog stanja pripravnosti, potpuno gašenje sprečava učitavanje OS-a i štiti od određenih napada usmerenih na RAM. Takođe aktivira sigurnost vašeg BIOS/UEFI sistema.



Konačno, jedna od najvažnijih mera koju možete preduzeti da biste se zaštitili od krađe je aktiviranje potpune enkripcije diska. Ovo štiti vaše podatke tako što ih čini nedostupnim bez lozinke, čak i ako je disk izvađen i priključen na drugi uređaj. Na nekim sistemima, ova enkripcija je podrazumevano omogućena:




- macOS koristi FileVault
- Windows koristi BitLocker, ali njegova aktivacija zavisi od mašine i verzije operativnog sistema
...
U konkretnim terminima, na vašem ličnom računaru, to znači da vaš glavni korisnički nalog ne sme imati administratorska prava za svakodnevne aktivnosti: pregledanje interneta, proveru e-pošte, kancelarijski rad, itd. Naime, ako se zlonamerni softver pokrene sa nalogom koji ima povišena prava, moći će da modifikuje sistemske fajlove, instalira trajne servise ili onemogući sigurnosne zaštite. Suprotno tome, ako se pokrene u ograničenom okruženju, njegova sposobnost da nanese štetu biće ograničena.



Na Windows-u, većina korisnika ima administratorski nalog po defaultu, iako je to loša praksa. Preporučujem da kreirate standardni korisnički nalog za svakodnevnu upotrebu, a da administratorski nalog ostavite za operacije koje ga zaista zahtevaju. Kada pokušate da izvršite zadatak koji zahteva povišene privilegije, Windows će jednostavno tražiti da unesete administratorsku lozinku umesto da jednostavno kliknete na dugme "*YES*".
...
Pod Linuxom, ovo načelo najmanjih privilegija je bolje primenjeno. Po defaultu, imate korisnički nalog sa ograničenim pravima, a možete privremeno povećati svoje privilegije pomoću komande `sudo`. Takođe je moguće konfigurisati `sudo` da autorizuje samo određene komande u zavisnosti od korisnika (putem `/etc/sudoers`).
...
Na macOS-u, iako prvi kreirani nalog često ima administratorska prava, sistem koristi mehanizam sličan `sudo`: potrebno je da potvrdite svoje akcije lozinkom za svaku kritičnu operaciju. Ipak, potpuno je moguće kreirati standardni korisnički nalog i rezervisati administratorski nalog za povremenu upotrebu, što preporučujem ako računar koristi više osoba.



Ova podela nije ograničena na ljudske korisnike. Mnoge aplikacije zahtevaju povišene privilegije prilikom instalacije, a zatim nastavljaju da rade sa tim pravima kada više nisu potrebna. Stoga vam savetujem da, gde god je to moguće, preferirate aplikacije koje rade u korisničkom režimu, da deinstalirate softver koji više ne koristite i da budete oprezni sa zahtevima za povišenje privilegija.
...
Na primer, možete strukturirati svoje sesije na sledeći način:
...
Na Linuxu, ovo razdvajanje može biti pojačano mehanizmima kao što su AppArmor ili SELinux, koji se mogu koristiti za dodatno ograničavanje prava pristupa za svaku sesiju.
...
Konačno, drugi pristup, radikalniji ali posebno efikasan, jeste posvetiti poseban računar za svaku upotrebu, na primer: jedan laptop posvećen isključivo profesionalnim aktivnostima, drugi za ličnu upotrebu, i treći jednostavan, dobro zaštićen rezervisan za osetljive aktivnosti.
...
Virtuelne mašine (ili "VMs") omogućavaju vam da kreirate potpuno izolovana okruženja unutar vašeg računara. VM simulira nezavisan računar sa sopstvenim operativnim sistemom, aplikacijama i podešavanjima, ali u stvarnosti funkcioniše kao program koji radi na vašem glavnom računaru.



Ova tehnologija se zasniva na hipervizoru, softverskom programu koji upravlja kreiranjem i izvršavanjem VM-ova. Najpoznatije rešenje je VirtualBox, softverski paket otvorenog koda koji je kompatibilan sa više platformi. Omogućava jednostavno kreiranje VM-a u samo nekoliko klikova, dodeljivanjem specifičnih resursa.
...
Konačno, važno je razumeti da bezbednost koju pružaju VM-ovi zavisi od njihove ispravne konfiguracije. Podrazumevano, neki hipervizori dozvoljavaju razmenu fajlova između hosta i VM-a, ili omogućavaju pristup USB perifernim uređajima. Ove funkcije treba onemogućiti kako bi se maksimizovala izolacija.
...
Sandboxing je metoda računarske bezbednosti koja podrazumeva pokretanje aplikacije ili procesa u izolovanom, veoma ograničenom okruženju. Cilj je strogo ograničiti interakciju aplikacije sa ostatkom sistema. Ako se pojavi pretnja, njeni efekti su obično zadržani unutar ovog perimetra.



Za razliku od virtuelnih mašina, koje simuliraju kompletan operativni sistem sa sopstvenim resursima, sandboxing je lakši, brži za implementaciju i manje resursno intenzivan. Oslanja se na mehanizme za ograničavanje prava pristupa: memoriji, fajlovima, mreži, perifernim uređajima... Sandboxed aplikacija može, na primer, čitati privremeni fajl, ali nikada ne može pristupiti vašem ličnom direktorijumu ili fajl sistemu.



Evo nekoliko konkretnih rešenja za sandboxing, u zavisnosti od vašeg operativnog sistema:
...
- Na macOS-u, sandboxing je izvorna funkcija ugrađena u kernel, ali se aktivira samo ako to odredi programer softvera. Aplikacije iz App Store-a su automatski u sandbox-u, ali one instalirane sa weba (ili iz komandne linije) nisu u sandbox-u po defaultu.
...
## Smanjenje kvarova kroz održavanje
...
U ovom poglavlju, vodiću vas korak-po-korak kroz to kako efikasno održavati vaš računar i minimizirati rizik od kompromitovanja.
...
Kao što smo videli na početku ovog kursa, operativni sistem upravlja hardverom (procesor, memorija, diskovi, periferije, itd.), izvršava programe, organizuje fajlove i upravlja mrežnim konekcijama. Stoga je to kritična komponenta na vašoj mašini.



#### Zašto ažurirati vaš OS?



Zbog svoje složenosti, nijedna verzija operativnog sistema nije potpuno bez ranjivosti. Ovde govorimo o desetinama miliona linija koda. Ove sigurnosne slabosti mogu biti iskorišćene od strane napadača za izvršavanje zlonamernog koda, sticanje neovlašćenih privilegija ili kompromitovanje celog sistema. Neke od ovih ranjivosti odgovorno otkrivaju istraživači sajber bezbednosti, dok se druge već aktivno eksploatišu bez znanja šire javnosti: ove su poznate kao zero-day ranjivosti.



Dobavljači operativnih sistema redovno izdaju sigurnosne ispravke dizajnirane da isprave ove ranjivosti. Neuspeh u instaliranju ovih zakrpa je ekvivalentan namernom ostavljanju vrata otvorenim za napade, čak i ako mislite da je vaša upotreba skromna ili vaši podaci bezvredni.



Nije samo pitanje popravljanja vidljivih grešaka, već i delovanja na vektore napada vašeg sistema. Što je manje vektora, to napadači imaju manje poluga za kompromitovanje vaše mašine.
...
Konačno, imajte na umu da u mnogim slučajevima određene kritične nadogradnje stupaju na snagu tek nakon ponovnog pokretanja. Zato je važno redovno restartovati vaš uređaj, posebno nakon sistemske nadogradnje. Ažuriranje operativnog sistema često traje samo nekoliko minuta, ali je jedan od najefikasnijih bedema protiv mnogih napada.



#### Kako da ažuriram svoj OS?



Čak i ako su automatska ažuriranja omogućena na vašem sistemu, i dalje je važno ručno proveravati, u redovnim intervalima, da nema čekajućih ažuriranja. Pogledajmo kako to učiniti, u zavisnosti od vašeg sistema:
...
Windows ima centralizovani menadžer za ažuriranja pod nazivom "Windows Update". On automatski preuzima i instalira ažuriranja, sigurnosne zakrpe, drajvere uređaja, a ponekad čak i mikrokod za procesor.



Da ručno proverite status ažuriranja :
...
Bezbednost vašeg računara ne zavisi samo od vašeg operativnog sistema. Svaki softver koji instalirate predstavlja potencijalnu ulaznu tačku za napade. Čim program ima neispravljenu sigurnosnu manu, može biti iskorišćen za ugrožavanje vašeg sistema ili krađu vaših podataka.



Neki softveri su osetljiviji od drugih, jer direktno komuniciraju sa spoljnim svetom ili manipulišu potencijalno neprijateljskim fajlovima. Među najkritičnijim softverima su :
...
Naravno, ovi rizici ne proizlaze isključivo iz lošeg održavanja, ali je važno obratiti posebnu pažnju na ažuriranje ovih osetljivih softverskih programa. Ovde pojednostavljujem, ali naravno, sav vaš drugi softver takođe treba redovno ažurirati. Hajde da pogledamo kako to učiniti, u zavisnosti od vašeg operativnog sistema.
...
Na Windows 11, *Winget* alat je integrisan u sistem. Omogućava vam da prikažete i ažurirate većinu softvera instaliranog na vašem računaru, direktno putem terminala. Jednostavno pokrenite Windows PowerShell:
...
Ova komanda pretražuje javne repozitorijume za najnovije verzije softvera koji imate i automatski ih ažurira.
...
Nažalost, ova komanda ne radi za sav softver. Zato preporučujem da vodite spisak svog softvera i ručno proveravate ažuriranja redovno, posebno za osetljive aplikacije. Za najkritičniji softver, kao što su vaš antivirus ili veb pregledač, savetujem da ovu proveru obavljate svakodnevno.
...
Snaga Linux distribucija leži u njihovom centralizovanom upravljanju softverom. Upravljač paketima (`APT` u slučaju Debiana) održava sistem i sav instalirani softver ažurnim putem zvaničnih repozitorijuma.



Na isti način kao za ažuriranje OS-a, da biste izvršili globalno ažuriranje vašeg softvera, jednostavno pokrenite:
...
Ova osnovna komanda osvežava listu dostupnih paketa (`apt update`) i zatim primenjuje neophodne nadogradnje (`apt upgrade`).



Za potpunije ažuriranje, možete koristiti i ovu komandu:
...
Ako imate softver distribuiran kao Flatpak ili Snap pakete, neki se ažuriraju automatski, ali ih sve možete ručno ažurirati pomoću komande:
...
Softver instaliran putem App Store-a može se lako ažurirati u sledećem meniju:
...
Takođe možete aktivirati automatsko ažuriranje aplikacija u podešavanjima App Store-a.



Međutim, nisu sve aplikacije instalirane na vašem Mac-u preuzete iz App Store-a. Za druge aplikacije, moraćete da ih ažurirate ručno. Dakle, kao i korisnicima Windows-a, preporučujem da vodite spisak svog softvera i redovno proveravate nove verzije, posebno za one osetljive kao što je vaš web pregledač.
...
Sa stanovišta IT bezbednosti, što manje softvera imate instalirano, to imate manje potencijalnih ulaznih tačaka za napadača. Svaka aplikacija instalirana na vašem sistemu može sadržati bezbednosne propuste, čak i ako je nikada ne koristite. Ovo je poznato kao površina napada: što je veća, to je veći rizik. Smanjenje ove površine uklanjanjem nepotrebnog softvera je jednostavna, ali efikasna preventivna mera.



Neke unapred instalirane aplikacije ili programi instalirani za jednokratnu upotrebu mogu ostati na vašem računaru mesecima bez korišćenja, dok nastavljaju da primaju ažuriranja ili komuniciraju sa vašim sistemom. Još gore, ako se ovi programi više ne održavaju, mogu sadržati ranjivosti.
...
Da biste pristupili listi instaliranih aplikacija:
...
Prođite kroz ovu listu softvera i uklonite sve što više ne koristite ili ne znate čemu služi (nakon brze provere na internetu ako je potrebno). Budite pažljivi sa sistemskim softverom, ali ne oklevajte da deinstalirate unapred instalirane igre, sumnjive alate za održavanje ili marketinške aplikacije.
...
Otvorite terminal i pokrenite sledeću komandu da biste obrisali softverski program:
...
Zatim pokrenite ovu komandu da automatski uklonite sve zavisnosti koje više nisu potrebne:
...
Pod macOS-om postoje 2 glavne metode: putem *Launchpad*-a ili putem *Finder*-a. Ako je aplikacija preuzeta iz App Store-a, otvorite *Launchpad* (iz Dock-a ili direktorijuma `/Applications`), pronađite aplikaciju, zatim držite pritisnut taster Option ili dugo kliknite dok ikone ne počnu da se tresu. Zatim kliknite na krstić pored aplikacije i potvrdite brisanje.
...
Ako se dugme za brisanje ne pojavljuje, aplikacija nije instalirana iz App Store-a. U tom slučaju, koristite *Finder*. Prvo zatvorite aplikaciju, ako je pokrenuta. Otvorite *Finder*, idite u direktorijum `/Applications`, izaberite aplikaciju koju želite da obrišete, zatim je premestite u kantu za smeće. Na kraju, ispraznite kantu za smeće da biste završili deinstalaciju.



#### Ne zaboravite ekstenzije za pregledač



Ekstenzije i dodaci vašeg pregledača često se zanemaruju, ali i oni predstavljaju čest vektor napada. Zlonamerna ili zastarela ekstenzija može presresti vaše podatke o pretraživanju, ubaciti kod ili vas diskretno špijunirati.



Idite u postavke pregledača i onemogućite ili izbrišite sve ekstenzije koje ne koristite ili ne znate. Zadržite samo one koje su strogo neophodne, iz pouzdanih izvora i koje se još uvek održavaju.



### Praćenje i revizija sistema



Sajber bezbednost takođe uključuje praćenje aktivnosti sistema. Ovaj proaktivan pristup omogućava rano uočavanje abnormalnog ponašanja (sumnjive veze, neobični procesi, pokušaji neovlašćenog pristupa, itd.) i intervenciju pre nego što dođe do ozbiljnog incidenta.



Ako postavite rutinu za reviziju (čak i osnovnu), možete otkriti prisustvo malvera, uspavanih trojanaca ili špijunskog softvera u ranoj fazi. Takvo praćenje može se obaviti korišćenjem specijalizovanih alata.
...
Kao što smo videli u prethodnom odeljku, Windows je istorijski bio više izložen napadima na računare, zbog svoje široke upotrebe i tehničkih specifičnosti. Stoga je važno dopuniti osnovnu zaštitu naprednim dijagnostičkim alatima:
...
Na dobro održavanom Linux računaru koji se koristi u lične svrhe, rizici su manji. Ipak, evo nekoliko naprednih alata za praćenje vašeg sistema :
...
macOS je poznat po svojoj sigurnosti, zahvaljujući posebno svojim politikama potpisivanja aplikacija i relativno zatvorenoj arhitekturi. Za ličnu upotrebu, ažurirana mašina sa podrazumevanim postavkama već nudi pristojnu sigurnost. Da biste dodatno unapredili nadzor vašeg sistema, preporučujem:
...
### Zaključak: bezbednost je stvar pravilnosti



Optimalna bezbednost računara se ne postiže instaliranjem specifičnih alata jednom, već redovnim, rigoroznim i metodičnim održavanjem. Ažuriranje operativnog sistema, nadogradnja kritičnog softvera, brisanje nepotrebnog softvera i aktivno praćenje sistema su temelji dobrog održavanja. Generalno, ove najbolje prakse se primenjuju na sve vaše digitalne alate: povezane uređaje, servere, pametne telefone...



U sledećem poglavlju, pogledaćemo kako možete izbeći instaliranje malvera u praksi, tako što ćete naučiti kako da proverite integritet i autentičnost fajlova koje preuzimate na svoj računar.




## Integritet i autentičnost softvera
...
Instaliranje softvera na vašem računaru može delovati kao trivijalna operacija, ali u stvarnosti predstavlja veoma ozbiljan potencijalni rizik za bezbednost vašeg računara. Naime, preuzeti softver može biti izmenjen ili zaražen od strane napadača, koji koriste ovu priliku da ubace viruse, trojance i druge vrste malvera u vaš sistem.



Provera integriteta i autentičnosti softvera pre instalacije je stoga veoma važna bezbednosna praksa, posebno kada je reč o osetljivom softveru kao što su Bitcoin novčanici ili menadžeri lozinki. Ova praksa osigurava da preuzeti softver tačno odgovara onom koji je objavio originalni developer, bez izmena.



U ovom poglavlju ćemo pogledati kako proveriti integritet i autentičnost datoteke, i kako to sprovesti na vašem operativnom sistemu.



### Zašto verifikovati integritet i autentičnost softvera?



Kada preuzimate softver sa Interneta, implicitno verujete datoteci da će se pokrenuti na vašem računaru. Ali to poverenje nikada ne bi trebalo da bude slepo. Zato je važno razumeti dva osnovna koncepta: integritet datoteke i autentičnost.



#### Integritet: osiguravanje da nije došlo do izmene



Integritet datoteke garantuje da ona nije bila izmenjena, namerno ili nenamerno, između trenutka kada ju je objavio programer i trenutka kada ste je preuzeli. Čak i najmanja izmena može biti dovoljna da se ubaci zlonamerni kod u softver.
...
#### Autentičnost: garantovanje da softver dolazi iz pravog izvora
...
Proverom autentičnosti (tj. da instalaciona datoteka dolazi iz pravog izvora) i integriteta (tj. da nije modifikovana od kada ju je objavio legitimni developer), možete biti sigurni da instalirate pravi softver.



#### Tehnička rešenja: Hash i digitalni potpis
...
Ako koristite Linux, GPG je unapred instaliran na većini distribucija. Ako nije, možete ga instalirati sledećom komandom:
...
Zatim instalirajte GPG ovom komandom:
...
Za Windows, ako nemate GPG, možete instalirati [Gpg4win](https://www.gpg4win.org/).
...
Posetite zvaničnu veb stranicu [Sparrow wallet u sekciji "_Download_"](https://sparrowwallet.com/download/). Ako želite da pogledate neki drugi program, molimo vas da posetite sajt za taj program.
...
Možete takođe otići [na GitHub repozitorijum projekta](https://github.com/sparrowwallet/Sparrow/releases).
...
Takođe preuzmite PGP potpis datoteke. Ovo je `.asc` dokument.
...
Obavezno postavite sve ove datoteke u isti direktorijum kako biste olakšali sledeće korake.



Na kraju, trebaće vam javni ključ programera da biste verifikovali PGP potpis. Ovaj ključ je obično dostupan na zvaničnom sajtu softvera, na GitHub repozitorijumu projekta, ponekad na društvenim mrežama programera ili na specijalizovanim platformama kao što je Keybase.



U slučaju *Sparrow wallet*, možete pronaći javni ključ programera [Craig Raw na Keybase](https://keybase.io/craigraw). Da biste ga preuzeli direktno iz terminala, pokrenite sledeću komandu:
...
Da biste bili sigurni da koristite pravi javni ključ programera, a ne onaj koji je preuzeo napadač, preporučujem da proverite izvore: proverite da li se otisak ključa podudara na Keybase-u, na zvaničnom sajtu projekta i na bilo kojim društvenim mrežama ili komunikacionim kanalima programera.
...
Proces verifikacije potpisa je identičan na Windows, macOS i Linux sistemima. Trebalo bi da ste već uvezli javni ključ u prethodnom koraku, ali ako to još niste uradili, možete ga uvesti koristeći sledeću komandu:
...
Zamenite `[key_path]` sa lokacijom datoteke javnog ključa programera.
...
Proverite potpis sledećom komandom:
...
Zamenite `[file.asc]` putanjom do datoteke potpisa. U slučaju Sparrow, ova datoteka se zove "_sparrow-2.0.0-manifest.txt.asc_" za verziju 2.0.0.
...
Na Windows-u, otvorite terminal i pokrenite sledeću komandu:
...
Zamenite `[file_path]` sa lokacijom instalacionog fajla.
...
Zatim uporedite rezultat sa odgovarajućom vrednošću u datoteci "_sparrow-2.0.0-manifest.txt_".
...
Zamenite `[file_name]` imenom autentifikovane datoteke koja sadrži hešove. Na primer, za Sparrow wallet verziju 2.0.0:
...
Ako se heševi podudaraju, izlaz bi trebao biti:
...
A ako se heševi poklapaju, trebalo bi da dobijete:
...
Sada možete biti sigurni da je softver koji ste preuzeli i originalan i pouzdan. Sada ga možete instalirati na svoj uređaj.
...
Provera integriteta i autentičnosti je prilično jednostavna praksa, ali pruža konkretnu, efikasnu zaštitu protiv velike većine pretnji povezanih sa preuzimanjem i instalacijom softvera.



U sledećem poglavlju, detaljnije ćemo razmotriti upravljanje podacima. Pogledaćemo kako možete zaštititi sebe od dva glavna rizika: gubitka podataka i krađe podataka.
...
### Pravljenje rezervne kopije vaših podataka



#### Zašto praviti rezervne kopije podataka?



Redovno pravljenje rezervnih kopija vaših ličnih ili poslovnih podataka je apsolutno neophodna sigurnosna mera, koja se često zanemaruje dok ne bude prekasno. Suprotno uvreženom mišljenju, pravljenje rezervnih kopija podataka nije opcioni zadatak niti zadatak samo za kompanije: tiče se svakog korisnika računara. Bilo da imate radne dokumente, porodične fotografije, lične dokumente ili bilo koji drugi osetljiv sadržaj, ovi podaci mogu iznenada nestati iz bilo kog razloga:





- Kvar hardvera: HDD-ovi i SSD-ovi imaju ograničen vek trajanja. Bez upozorenja, mogu otkazati, čineći podatke nedostupnim.
...
- Ljudska greška: nepravilno rukovanje, slučajno brisanje ili nenamerno formatiranje može dovesti do nepovratnog gubitka.





- Fizička katastrofa: požar, oštećenje vodom, krađa ili čak prenapon mogu učiniti vašu opremu neupotrebljivom u trenutku.
...
#### Metoda 3-2-1: robustan standard bezbednosti



Pravilo "3-2-1" je prepoznati standard u IT bezbednosti. Zasniva se na jednostavnim, ali veoma efikasnim principima koji garantuju toleranciju na greške i incidente. Evo kako funkcioniše:





- 3 kopije vaših podataka: ovo uključuje original (datoteke na vašem računaru) i dve dodatne rezervne kopije.
...
- 1 kopija van lokacije: ova kopija mora biti smeštena dalje od vaših glavnih prostorija (u kući rođaka, na udaljenom serveru, u sigurnom oblaku...). Ona vas štiti od lokalnih incidenata kao što su požar ili provala.
...
Ova strategija garantuje izvanrednu otpornost: ako njen računar padne, može vratiti svoje fajlove sa USB-a ili iz oblaka; ako provajder usluge skladištenja u oblaku doživi veliki kvar, ona i dalje ima svoje fajlove lokalno; čak i u slučaju provale gde su njen laptop i USB ukradeni, može povratiti svoje podatke putem usluge u oblaku.
...
Jedan od najboljih načina da osigurate dobru higijenu bekapa je automatizacija. Konfigurišite svoje alate tako da se bekapi pokreću automatski prema rasporedu (svake noći, svake nedelje...). Ovo sprečava previd i garantuje kontinuitet čak i u slučaju vaše privremene nedostupnosti.



U praktičnom smislu, postoji nekoliko načina da automatizujete svoje bekape. Možete, na primer, kreirati Python skriptu koja se automatski pokreće kako bi kopirala vaše podatke na eksterni medijum. To je jednostavno, prilagodljivo rešenje.



Ako imate NAS, alati kao što su *Syncthing* ili *Rclone* omogućavaju vam da automatizujete bekapove unutar vaše lokalne mreže, bez korišćenja Interneta.
...
Da biste automatizovali bekapove na cloud servis, možete koristiti integracioni softver koji obezbeđuje sam provajder. Jedan primer je *Proton Drive*, koji nudi klijent za sinhronizaciju kako bi automatski kopirao vaše lokalne fajlove na cloud. Takođe možete izabrati fleksibilniji softver kao što je *Duplicati*, koji vam omogućava da zakažete enkriptovane bekapove na brojne udaljene servise (Dropbox, Google Drive, Proton Drive, FTP, WebDAV...).
...
Takođe zapamtite da redovno testirate svoje rezervne kopije, tj. da proverite da li možete da ih vratite. Rezervna kopija je beskorisna ako je oštećena, nepotpuna ili nečitljiva.



Osim što osiguravate otpornost vaših podataka, jednako je važno zaštititi pristup njima. Zapravo, otpornost i sigurnost su često u napetosti: što više kopija napravite od svojih fajlova, to više povećavate njihovu površinu napada, a samim tim i rizik da napadač dobije pristup njima. Zato je šifrovanje vaših podataka ključni korak. Pogledajmo kako to sprovesti u praksi.



### Potpuna enkripcija eksternih diskova i medija
...
Kada medij za skladištenje nije šifrovan, jednostavno ga priključite na bilo koji računar da biste odmah pristupili njegovom sadržaju. Ne postoje barijere koje štite fajlove. To znači da ako vam ukradu laptop ili izgubite jednostavan USB ključ, neko sa zlonamernim namerama mogao bi da pristupi vašim ličnim dokumentima.



Pored pitanja privatnosti koja su u igri, vaši fajlovi takođe mogu predstavljati stvarni bezbednosni rizik. Uzmimo konkretan primer: ako vaši bekapi sadrže kopiju vaših identifikacionih dokumenata, napadač bi ih mogao iskoristiti da se predstavi kao vi, otvori bankovne ili kripto račune na vaše ime, ili čak uzme bankarske kredite na vaše ime. Ovakav tip curenja informacija može imati ozbiljne posledice, kako lično, tako i profesionalno.



Puna enkripcija je kao brava: sve dok lozinka nije obezbeđena, podaci ostaju neupotrebljivi. Čak ni napadač opremljen specijalizovanim alatima za oporavak podataka neće moći da izvuče ništa bez ključa.



#### Koja tehnička rešenja nudi vaš sistem?
...
Uverite se da imate instaliran paket *cryptsetup*:
...
Počnite identifikovanjem vašeg USB ključa sledećom komandom:
...
Trebalo bi da vidite uređaj poput `/dev/sdb` sa pridruženom particijom, na primer `/dev/sdb1`. Budite pažljivi pri odabiru pravog diska, jer će biti obrisan!



Da biste šifrovali ključ, pokrenite sledeću komandu za inicijalizaciju šifrovanja:
...
Moraćete da unesete svoj passphrase da biste otključali volumen. `encrypted_usb` je ime dato dešifrovanom volumenu.
...
Ili, ako želite kompatibilnost sa Windows-om:
...
Zatim možete bezbedno ukloniti svoj USB ključ.



Za buduću upotrebu vašeg USB fleš drajva:
...
Ako želite, možete automatizovati ovu sekvencu koristeći Python ili Bash skripte.
...
Da biste otvorili softver, idite na Ubuntu meni aplikacija i potražite "*Disks*". Obično se po defaultu nalazi u direktorijumu "*Utilities*".



U levom stupcu pronađite vaš USB ključ. Ako particija već postoji, odaberite je; ako ne, kreirajte novu: kliknite na dugme "+" ispod liste particija.
...
Unesite i potvrdite robustan passphrase.
...
Potvrdite i sačekajte da particija bude potpuno formatirana (svi podaci će biti obrisani).
...
Kada je proces završen, particija se pojavljuje sa malim katancem. Izaberite je, zatim kliknite na katanac da ga otključate.
...
Da biste demontirali USB ključ i ponovo aktivirali enkripciju, kliknite ponovo na ikonu katanca u GNOME Disks.



Na kraju, kliknite na dugme u obliku strelice u gornjem desnom uglu da biste ispravno izbacili ključ sa vašeg računara. Sledeći put kada se prijavite, Ubuntu bi trebalo automatski da detektuje vaš šifrovani ključ i zatraži od vas lozinku, bez potrebe za otvaranjem GNOME Disks.
...
Da biste saznali više o ovom rešenju, pogledajte ovaj kompletan vodič :
...
Da biste videli sve metapodatke sadržane u datoteci, koristite sledeću komandu:
...
Zatim ćete videti dugačku listu atributa, koja potencijalno uključuje:
...
- GPS lokacija
- Proizvođač i model kamere
- Softver korišćen za uređivanje
- Informacije o autoru...



Ovo vam daje potpuni pregled onoga što ćete objaviti ili preneti.





- Korak 3: Izbriši metapodatke



Da biste obrisali sve nepotrebne metapodatke iz datoteke, koristite komandu:
...
Ova komanda automatski kreira kopiju originalne datoteke sa uklonjenim metapodacima. Original se čuva sa dodatkom `_original` u imenu.
...
Ako ne želite da zadržite original, možete ga obrisati komandom:
...
Ako ponovo pogledamo metapodatke naše datoteke, možemo videti da su svi nepotrebni ili osetljivi metapodaci uklonjeni.
...
- Korak 4: Očistite ceo direktorijum



Ako imate nekoliko fajlova za obradu u istom direktorijumu, možete koristiti generičku komandu kao što je:
...
Kao alternativu za ExifTool, možete koristiti MAT2 (*Metadata Anonymization Toolkit v2*).
...
Jednom instaliran, možete ga koristiti iz komandne linije ovako:
...
Podrazumevano, MAT2 ne menja originalnu datoteku: kreira očišćenu verziju u istom direktorijumu sa dodatkom `-clean` na kraju.
...
Da očistite čitav direktorijum, kao što je direktorijum `/Downloads`:
...
### Druge platforme (Windows i macOS)
...
Sačekajte nekoliko trenutaka dok alat očisti metapodatke. Kada proces bude završen, videćete rezime koji prikazuje početne i konačne brojeve metapodataka. Svi suvišni podaci će biti uklonjeni.
...
Čišćenje metapodataka datoteka koje delite stoga je dobra praksa koju treba usvojiti kada je reč o IT bezbednosti. Zahvaljujući jednostavnim alatima predstavljenim u ovom poglavlju, to je navika koju možete lako primeniti svakodnevno.



Došli smo do kraja ovog dela o obezbeđivanju vašeg računara. U sledećem delu ćemo detaljno razmotriti jedan od najvažnijih programa na vašem računaru: veb pregledač. On sam centralizuje veliki deo vaših digitalnih aktivnosti, što ga čini glavnom metom u smislu bezbednosti i privatnosti.




# Pregledač: OS unutar OS-a
...
Ipak, nije oduvek imao ovu centralnu ulogu. Istorija pregledača obeležena je ciklusima inovacija, tehnološke konkurencije i ponekad monopolističke dominacije. Praćenje ove istorije pomoći će nam da razumemo kako su pregledači postali tako složeni i zašto je njihova bezbednost danas tako važna tema.



→ Pregledač se često pogrešno meša sa pretraživačem. Ipak, ta dva su veoma različita. Veb pregledač se koristi za prikazivanje veb sajtova, dok se pretraživač (kojem se može pristupiti iz veb pregledača) koristi za pronalaženje informacija na mreži indeksiranjem i klasifikovanjem veb stranica.
...
1992. godine je takođe stvoren Lynx, najstariji veb pregledač koji se i dalje održava i koristi. Razvijen je od strane tima studenata na Univerzitetu u Kanzasu.



Ali, 1993. godine, Web je zaista ušao u fazu brzog rasta dolaskom NCSA Mosaic-a. Ovaj pregledač su razvili Marc Andreessen i Eric Bina u NCSA (*National Center for Supercomputing Applications*) u SAD-u. Mosaic je prvi mainstream pregledač koji je besprekorno kombinovao tekst i slike u jednom prozoru. Može direktno prikazivati slike na web stranicama (GIF i XBM formati), što predstavlja ergonomski napredak u poređenju sa tekstualnim pregledačima kao što je Lynx. Mosaic je takođe uveo podršku za forme, otvarajući put za pravu interaktivnost između korisnika i web servera. Mosaic je brzo prenet na nekoliko operativnih sistema (Windows, Mac, Unix), što je olakšalo distribuciju. U roku od godinu dana, postao je standardni alat za istraživanje Web-a.
...
Godine 1994, Marc Andreessen je napustio NCSA i osnovao Netscape Communications sa Jimom Clarkom. Veliki deo tima koji je radio na Mosaic-u pridružio mu se. Nedugo zatim, kompanija lansira Netscape Navigator, pregledač zasnovan na temeljima Mosaic-a, ali sa boljim performansama i tehničkim poboljšanjima. Godine 1995, Netscape je inovirao uvođenjem JavaScript jezika, koji je razvio Brendan Eich, što je omogućilo da web stranice postanu dinamične, tj. sposobne da reaguju na akcije korisnika bez ponovnog učitavanja stranice.
...
Zahvaljujući lakoći korišćenja, kompatibilnosti sa različitim platformama i brzini, Netscape Navigator se brzo uspostavio kao standard za novu mrežu. Do 1995. godine držao je do 90% tržišnog udela, označavajući početak prve ere web pregledača. Ovaj ogroman uspeh ubrzo je naveo Microsoft na reakciju, što je dovelo do rata pregledača.
...
Meteorijski uspeh Netscape Navigatora sredinom 1990-ih nije promakao Microsoftu, koji je brzo shvatio strateški značaj web pregledača u budućnosti računarstva. U avgustu 1995. godine, nekoliko dana nakon objavljivanja Windows 95, Microsoft je lansirao prvu verziju Internet Explorera, koja je u početku bila zasnovana na komercijalnoj licenci izvornog koda Spyglass Mosaic (druga komercijalna verzija Mosaica od one razvijene na NCSA).
...
Strategija Microsofta zasniva se na nekoliko tehničkih i komercijalnih poluga:
...
### Tehnološka obnova: Mozilla Firefox i Safari
...
- modularni sistem ekstenzija, koji omogućava korisnicima da lako dodaju nove funkcije bez diranja u srž pregledača;
- pregledavanje putem kartica, popularno među širom javnošću, iako već prisutno u starijim pregledačima kao što je Opera;
- alatke za privatnost kao što su blokiranje iskačućih prozora, integrisani menadžer lozinki i opcije za fino podešavanje kolačića i JavaScript-a.
...
Safari je postao podrazumevani pregledač na svim Mac računarima počevši od Mac OS X Panther (10.3), postepeno zamenjujući Internet Explorer za Mac, koji je Microsoft napustio 2005. godine. WebKit će takođe kasnije biti korišćen u mnogim drugim pregledačima.
...
### Tržišna revolucija: dolazak Google Chrome-a



Dana 2. septembra 2008. godine, Google je najavio izdavanje sopstvenog web pregledača: Google Chrome. U to vreme, Firefox je napredovao, a Internet Explorer je i dalje bio dominantan, ali sve više kritikovan zbog sporosti, nestabilnosti i zaostajanja za modernim standardima. Google, koji se u velikoj meri oslanja na web za svoje usluge (pretraga, Gmail, Mape...), želeo je pregledač bolje prilagođen eri složenih web aplikacija.
...
Chrome je u početku bio zasnovan na dva tehnička stuba:




- WebKit rendering engine, nasleđen iz Safari i KHTML, za prikazivanje HTML/CSS;
- novi JavaScript engine, nazvan V8, napisan u C++ koji kompajlira JavaScript kod u mašinske instrukcije u hodu (JIT, za *Just-In-Time*), značajno poboljšavajući performanse dinamičkih web aplikacija.
...
Podržan Google-ovim brendom i veoma efikasnom marketinškom kampanjom, Chrome je brzo stekao udeo na tržištu. Njegova brzina i jednostavnost korišćenja osvojili su korisnike. U 2012. godini, Chrome je po prvi put premašio Internet Explorer u globalnom udelu na tržištu.
...
Od 2025. godine, Google Chrome drži oko 66% globalnog tržišta na svim uređajima (računari, pametni telefoni, tableti), prema podacima StatCounter-a. Sledi ga na dalekom drugom mestu Safari (uglavnom na iOS/macOS), Microsoft Edge i Firefox, čiji tržišni udeo nastavlja da opada. Dominacija Chrome-a se takođe proširila na mobilni ekosistem putem Android WebView-a (sistemska komponenta koju koriste hiljade aplikacija), koji se takođe oslanja na Blink.



Chrome je duboko redefinisao performanse, bezbednosne i ergonomske standarde modernih pregledača, dok je postavio nove izazove u centralizaciji i standardizaciji veb tehnologija.
...
- Pregledač šalje HTTP zahtev udaljenom serveru;
- Server odgovara HTML dokumentom;
- Render engine analizira ovaj HTML, preuzima povezane datoteke (CSS, JavaScript, slike...);
- Gradi "DOM" (*Document Object Model*) koji predstavlja strukturu dokumenta;
- Primjenjuje CSS pravila za izračunavanje prikaza svakog elementa (*layout*);
- Prikazuje grafiku koristeći grafičku karticu i sistem za prozore.
...
Dizajniran od strane Netscape-a, a zatim održavan od strane Mozilla Foundation, Gecko pokreće Firefox pregledač. Od samog početka, Gecko je bio rigorozan u svom pridržavanju standarda. Napisan je u C++ i podržava brojne platforme.



Gecko je bio izvor mnogih inovacija. Međutim, njegova složena i istorijska baza koda čini određene evolucije sporim.
...
Razvijen od strane KDE projekta za njegov Konqueror pregledač, KHTML je lagan, modularan i brz engine. Napisan u C++, poštuje standarde i nudi čistu, dobro dokumentovanu bazu. Upravo je ovaj engine Apple izabrao 2001. godine da kreira WebKit. KHTML je stoga tehnički predak Chrome-a i Safari-ja.
...
- WebCore za renderovanje HTML/CSS ;
- JavaScriptCore (takođe poznat kao "Nitro") za izvršavanje JavaScript koda.
...
### Blink dominira, Gecko se muči



Od stvaranja Blinka 2013. godine i njegove široke primene u svim pregledačima zasnovanim na Chromiumu, ovaj rendering engine je postao dominantan. Do 2025. godine, on pokreće ne samo Google Chrome, već i Microsoft Edge (od 2020. godine), Operu, Brave, Vivaldi i mnoge druge manje poznate pregledače. Njegova dominacija prelazi 80% tržišnog udela na desktop računarima, a posebno na Androidu, gde Chrome dolazi unapred instaliran.



Ova situacija donosi određene prednosti: Blink je moćan i podržan od strane velikih inženjerskih timova (Google, ali i Microsoft i drugi), i brzo se razvija. Blink takođe doprinosi određenoj de facto standardizaciji: web programeri mogu ciljati jednu platformu kako bi dosegli skoro sve korisnike. Ali ova koncentracija takođe ima ozbiljne strukturne nedostatke.
...
S druge strane, ova centralizacija oko Blink-a znači da Google de facto kontroliše tempo evolucije i tehničke prioritete weba. Međutim, njegovi komercijalni interesi (oglašavanje, praćenje ponašanja, vlasnički formati, itd.) mogu biti u sukobu sa principima neutralnosti, interoperabilnosti i privatnosti koje su istorijski branili igrači poput Mozille.
...
U prostoru od trideset godina, veb pregledač je evoluirao od jednostavnog alata za pregledanje do složene softverske platforme, integrisane u samo srce našeg svakodnevnog računalnog iskustva. Razumevanje ove istorijske evolucije pojašnjava strateški značaj pregledača u današnjim pitanjima bezbednosti i digitalnog suvereniteta.



U sledećem poglavlju, pružićemo pregled trenutno dostupnih pregledača, od tradicionalnih do futurističkih, upoređujući njihove prednosti i nedostatke kako bismo vam pomogli da donesete informisanu odluku.
...
Nakon što smo istražili istoriju i evoluciju pregledača, sada ćemo pogledati glavne pregledače dostupne danas. Izbor pregledača nije beznačajan, posebno ako je, kao u našem slučaju, prioritet sigurnost, privatnost i digitalni suverenitet. Svaki pregledač ima specifične prednosti, ali i slabosti, često povezane sa njihovim poslovnim modelom ili tehničkim izborima.



Cilj ovog poglavlja je da vam pomogne da izaberete pregledač koji najbolje odgovara vašim potrebama. Organizovao sam ih prema rendering engine-u, ali redosled ne odražava bilo kakav rang.



### Pregledači zasnovani na Blink-u
...
Još jedna stvar koju treba uzeti u obzir je da zbog ove brzine i složenosti, Chrome troši ogromnu količinu sistemskih resursa, posebno RAM-a.



Google Chrome je zasnovan na projektu Chromium, koji je otvorenog koda. Međutim, Google dodaje mnogo vlasničkog koda. Stoga se ne smatra potpuno otvorenim kodom.



Dakle, ne bih preporučio korišćenje Google Chrome-a, ni lično ni profesionalno (osim, naravno, ako vaše poslovanje zavisi od Google paketa). Zapravo, postoje neke odlične alternative za Google-ove usluge, kako lokalne tako i u oblaku. Posebno vas pozivam da otkrijete usluge koje nudi Proton :
...
Iako su mnogi pregledači (uključujući Brave) zasnovani na Chromium-u dok tvrde da imaju pristup orijentisan na privatnost, istraga sprovedena 2024. godine otkrila je integraciju, po defaultu, API-ja koji omogućava Google-u pristup osetljivim informacijama o hardveru korisnika (CPU, GPU, RAM), kao i njegovoj ili njenoj aktivnosti na Google servisima. Ovaj API, integrisan kao ekstenzija koja se ne može deaktivirati u Chrome-u, bio je prisutan i u nekoliko izvedenih pregledača kao što su Edge, Opera... pa čak i Brave.



Iako je Brave od tada deaktivirao ovaj API, ovaj slučaj jasno ilustruje strukturnu zavisnost ovih pregledača od Chromium-a, koji ostaje projekat duboko povezan sa Google ekosistemom. Kao rezultat, čak ni varijante Chromium-a orijentisane na privatnost ne mogu garantovati potpunu nezavisnost ili potpunu zaštitu korisničkih podataka.
...
- Vaša verzija softvera,
- Instalirani fontovi,
- Rezolucija i veličina vašeg ekrana,
- Dubina boje,
...
[Vivaldi](https://vivaldi.com/), osnovan od strane bivšeg izvršnog direktora Opere, cilja napredne korisnike koji traže dublju personalizaciju i napredne funkcije kao što su bočne trake, napredni upravitelj kartica i integrisano vođenje beleški.



Što se tiče bezbednosti, Vivaldi uključuje nekoliko funkcija za blokiranje tragača i oglasa, ali te zaštite su nešto slabije nego kod Brave-a. Takođe je manje transparentan u određenim aspektima, jer je njegov izvorni kod samo delimično otvoren. Ipak, nudi zanimljivu alternativu, manje fokusiranu na strogu privatnost nego Brave, ali više nego Chrome ili Opera.
...
Međutim, u pogledu privatnosti, Opera je veoma kontroverzna: od 2016. godine je u vlasništvu kineske kompanije, što postavlja pitanja o mogućoj eksploataciji korisničkih podataka. Opera uključuje integrisani VPN (više proxy nego pravi VPN), ali politika privatnosti nije jasna u vezi sa upravljanjem logovima. Opera je takođe vlasnički pregledač. Stoga se ne preporučuje, posebno kada je privatnost prioritet.
...
#### Specijalizovani pregledači



Pregledači zasnovani na Blink-u takođe uključuju brojne manje zastupljene pregledače, često dizajnirane da zadovolje specifične slučajeve upotrebe:
...
Polypane je vlasnički, plaćeni vlasnički pregledač zasnovan na Chromium-u, što ga čini idealnim za povremenu profesionalnu upotrebu. Nije pogodan za svakodnevno pretraživanje, a njegova politika privatnosti je u skladu sa komercijalnim softverom, bez posebnih garancija.
...
### Pregledači zasnovani na Gecko-u
...
[Firefox](https://www.mozilla.org/firefox/new/) je najistaknutiji pregledač koji koristi Gecko rendering engine. Razvijen od strane Mozilla Foundation, Firefox se ističe svojom jasnom politikom privatnosti: poboljšanom zaštitom od praćenja, naprednim opcijama za blokiranje kolačića trećih strana, izolovanim kontejnerima kartica i integracijom ekstenzija fokusiranih na sigurnost.



Mozilla je neprofitna organizacija, što joj daje relativnu nezavisnost od isključivo komercijalnih interesa, čak i ako ostaje finansijski zavisna od partnerstava sa Google-om. Potonji u velikoj meri finansira Mozilla Foundation, zvanično kako bi njegov pretraživač ostao podrazumevani u Firefox-u, i tako održava svoj tržišni udeo. Nezvanično, ova strategija omogućava Google-u da održava oblik kontrolisane konkurencije: podržavajući Mozillu, Google zadržava minimalnog konkurenta, što ublažava optužbe za zloupotrebu dominantne pozicije i smanjuje rizik od regulatornih sankcija.
...
Firefox je open source pregledač, distribuiran pod MPL (*Mozilla Public License*). Njegov kod je potpuno besplatan, modifikabilan i redistributivan, i predmet je brojnih spoljašnjih doprinosa.



Firefox ostaje merilo za sigurnost i privatnost, uprkos tome što zaostaje malo iza pregledača zasnovanih na Blink-u u određenim oblastima performansi. Može biti veoma dobar pregledač, sve dok je pravilno konfigurisan.
...
[Tor Browser](https://www.torproject.org/download/) je pregledač zasnovan na Firefox ESR. To je jedno od najrobustnijih rešenja za anonimnost na mreži. Preusmerava saobraćaj kroz Tor mrežu, čime sprečava bilo kakvu direktnu korelaciju između korisnika i web odredišta.
...
[LibreWolf](https://librewolf.net/) je pregledač zasnovan na Firefox-u, dizajniran da ponudi još viši nivo privatnosti. Uklanja sve funkcije koje bi mogle ugroziti privatnost, kao što su telemetrija, integracija Mozilla servisa i Pocket servis.



Podrazumevano, LibreWolf aktivira napredna sigurnosna podešavanja Firefoxa (kao što je strogi režim zaštite od praćenja) i onemogućava podršku za DRM. Projekat je potpuno otvorenog koda, zasnovan na zajednici i ne oslanja se na bilo kakvo finansiranje od strane privatnih preduzeća. Preporučujem ga ako tražite "ojačani" Firefox, sa maksimalnom kontrolom nad vašim podacima.
...
Orion se razlikuje od Safarija u nekoliko tehničkih aspekata:
...
Orion je u potpunosti razvijen od strane Kagi tima (poznatog po svom pretraživaču bez reklama). Njegov razvoj finansiraju isključivo njegovi korisnici putem *Orion+* pretplate, koja omogućava pristup brojnim prednostima.
...
Na kraju, želeo bih da završim ovaj pregled sa mnogo manje poznatom i veoma marginalnom alternativom: tekstualnim pregledačima, od kojih je najpoznatiji [Lynx Browser](https://lynx.invisible-island.net/).
...
Ovaj radikalno minimalistički pristup čini ga jednim od najsigurnijih pretraživača: nijedan zlonamerni skript ne može da se pokrene, nijedna nametljiva reklama se ne prikazuje, i nije moguće curenje podataka putem modernih mehanizama (canvas fingerprinting, JavaScript trackeri, itd).
...
Lynx može i dalje biti zanimljiv u određenim vrlo specifičnim kontekstima:
...
### Koji pregledač odabrati?



Za korisnike koji po defaultu prioritetizuju sigurnost i privatnost, bez potrebe za ručnim menjajem brojnih podešavanja, i koji traže browser opšte namene za svakodnevnu upotrebu, po mom mišljenju najbolji izbori su LibreWolf i Mullvad Browser. U istoj kategoriji, ako vam ne smeta korišćenje Chromium baze (uprkos uključenim rizicima i vrlo različitoj filozofiji), možete razmotriti i Brave. Kao što možete videti, preferiram Gecko rendering engine iz mnogo razloga, čak i ako trenutno zaostaje za Blink-om u pogledu performansi.



Firefox je takođe veoma dobra opcija kao pregledač opšte namene, sve dok je pravilno podešen za poboljšanje privatnosti.



Za još viši nivo anonimnosti, uz smanjenje performansi, Tor Browser ostaje najbolje rešenje.
...
Danas vaš izbor pregledača igra važnu ulogu u vašoj online sigurnosti i privatnosti. Zato odvojite vreme da identifikujete onaj koji najbolje odgovara vašem profilu rizika i prioritetima.
...
U prethodnom poglavlju, prošli smo kroz detalje glavnih pregledača koji su trenutno dostupni, zajedno sa njihovim prednostima i nedostacima u pogledu sigurnosti i privatnosti.
...
Ova tehnička složenost, u kombinaciji sa masivnom površinom napada, čini pregledač prioritetnom metom za napadače. Kritični nedostaci u rendererskim motorima (kao što su Blink ili Gecko), bibliotekama za analizu slika ili upravljačima memorije mogu omogućiti takozvane "zero-click" napade (dovoljno je posetiti zlonamerni sajt i vaša mašina je kompromitovana), ili "zero-day" napade (ranjivost nepoznata dobavljaču).
...
Da ručno proverite verziju i pokrenete ažuriranje:
...
Ažuriranje vašeg pregledača, softvera i operativnog sistema jedan je od prvih konkretnih koraka koje možete preduzeti u sajber bezbednosti.
...
Kada je reč o bezbednosti na internetu, jedna od najčešćih (i najopasnijih) grešaka je ponovno korišćenje lozinki na više sajtova. Ova praksa izaziva opasan domino efekat: ako je jedna usluga kompromitovana (curenje baze podataka, fišing, napad grubom silom...), napadač može zatim testirati istu lozinku na drugim platformama, dobijajući pristup kritičnim nalozima kao što su vaša e-pošta, bankovni računi ili radni prostori.



Prvi princip kada su u pitanju lozinke je da ih ne koristite ponovo. Svaki online nalog treba da bude zaštićen jedinstvenom lozinkom, potpuno različitom od ostalih. Imati jedinstvenu lozinku za svaki nalog izoluje potencijalne napade i ograničava njihov uticaj.



Na primer, ako koristite istu lozinku za platformu za video igre i za svoj email nalog, i ta lozinka bude kompromitovana putem phishing sajta povezanog sa platformom za igre, napadač bi tada mogao lako pristupiti vašem email nalogu i preuzeti kontrolu nad svim vašim drugim online nalozima.



Drugi suštinski princip je imati jaku lozinku. Lozinka se smatra jakom ako je teško probiti je metodom grube sile, tj. pronaći je pokušajem i pogreškom. To znači da vaše lozinke treba da budu što nasumičnije, duge i da uključuju raznovrsne karaktere (mala slova, velika slova, brojeve i simbole).



Primena ova dva principa sigurnosti lozinki (jedinstvenost i snaga) može biti teška na dnevnoj bazi, jer je praktično nemoguće zapamtiti jedinstvenu, nasumičnu i snažnu lozinku za sve naše naloge. Tu na scenu stupa menadžer lozinki.



Menadžer lozinki bezbedno generiše i čuva jake lozinke, omogućavajući vam pristup svim vašim online nalozima bez potrebe da ih pojedinačno pamtite. Potrebno je da zapamtite samo jednu lozinku, glavnu lozinku, koja vam daje pristup svim lozinkama sačuvanim u menadžeru. Korišćenje menadžera lozinki jača vašu online bezbednost, jer sprečava ponovnu upotrebu lozinki i sistematski generiše nasumične lozinke.
...
Kada je reč o autentifikaciji, korišćenje menadžera lozinki mora biti dopunjeno rešenjem za dvofaktorsku autentifikaciju (2FA), koje treba koristiti na svim nalozima koji je podržavaju. Idealno bi bilo koristiti specijalizovanu aplikaciju, ili još bolje, fizički uređaj kao što je Yubikey.
...
Takođe, VPN alati ne treba mešati sa Tor mrežom, koja je decentralizovana mreža enkriptovanih releja za garantovanje mnogo jače anonimnosti. Tor je sporiji, ali daleko otporniji na globalni nadzor nego VPN.
...
### Redovno brišite istoriju i kolačiće



Svaka veb stranica koju posetite beleži podatke o sesiji lokalno na vašem računaru, od kojih postoje dve glavne vrste: istorija pretrage i kolačići.



Istorija je jednostavna lokalna baza podataka koja navodi sve posećene sajtove, sa datumom, naslovom i ponekad vremenom kada su pregledani. Omogućava lako pronalaženje prethodno otvorene stranice. Ali s druge strane, izlaže sve vaše pretrage na mreži svakome ko ima pristup vašoj sesiji (uključujući zlonamerni softver ili radoznalog rođaka).



Kolačići, s druge strane, su mali fajlovi koje pregledač čuva na zahtev veb-sajtova. Koriste se za pamćenje vaše sesije (npr. da ostanete povezani na sajt), čuvanje vaših preferencija ili praćenje vašeg ponašanja u statističke svrhe. Neki kolačići su funkcionalni (tj. neophodni za pravilno funkcionisanje sajta), dok su drugi treće strane (postavljeni od strane reklamnih agencija ili tragača na posećenim stranicama). Ovi poslednji omogućavaju praćenje preko više sajtova, ponekad tokom godina, ukrštanjem vaših navika pretraživanja kako bi se uspostavio reklamni profil.



Redovno čišćenje ovih lokalnih podataka je jednostavan, ali efikasan način da se ograniči praćenje i sačuva vaša privatnost. Većina pregledača nudi opcije za:




- ili da ručno izbrišete ove podatke (u postavkama);
- ili da automatizujete brisanje svaki put kada zatvorite pregledač, ili za određeni vremenski period (preporučujem ovu opciju);
- bilo da pokrenete privremene sesije putem privatnog režima pretraživanja (više o tome u sledećem odeljku).
...
### Razumevanje privatnog pretraživanja



Režim privatnog pretraživanja, dostupan u svim modernim pregledačima (Firefox, Chrome, Brave, Safari...), često je pogrešno shvaćen. On nije alat za anonimizaciju, niti zaštita protiv praćenja na mreži. Ovaj režim samo ograničava beleženje lokalnih podataka na vašem računaru tokom aktivne sesije.



U konkretnim terminima, kada otvorite prozor u privatnom pretraživanju:




- istorija pretraživanja neće biti sačuvana lokalno na vašem uređaju;
- kolačići kreirani tokom sesije biće automatski obrisani kada se prozor zatvori;
- podaci obrasca (popunjena polja, lozinke) neće biti sačuvani;
- privremene datoteke povezane sa veb stranicama biće obrisane nakon zatvaranja.
...
Zato je važno ne mešati privatno pretraživanje sa anonimnošću. Za poboljšanu zaštitu vaše privatnosti na mreži, potrebno je koristiti komplementarne alate kao što su Tor ili dobar VPN, u zavisnosti od nivoa pretnje.
...
### Identifikacija i izbegavanje fišinga i socijalnog inženjeringa
...
Da biste izbegli ove napade prilikom pretraživanja interneta, važno je pratiti određene osnovne prakse:
...
A evo nekoliko preventivnih mera koje možete direktno primeniti u svom pregledaču kako biste smanjili rizik od fišinga :
...
Za važne usluge (vezane za bankarstvo, poresku upravu, e-mail, itd), i generalno za sve sajtove koje redovno koristite, sačuvajte zvanični URL u svojim obeleživačima i nikada ne koristite pretraživač ili spoljašnji link da biste došli do njih.



Da li ste primili e-mail od poreske uprave koji sadrži link? Nemojte kliknuti na njega. Umesto toga, idite direktno na vaš lični prostor koristeći URL koji ste sačuvali u svojim obeleživačima. Danas svi moderni pregledači nude traku sa obeleživačima sa opcijom organizovanja vaših linkova u foldere. Odvojite vreme da to uradite jednom, pažljivo proveravajući URL i SSL/TLS sertifikat, i moći ćete da pretražujete sigurnije.
...
Takođe je neophodno pratiti dobre prakse autentifikacije kako bi se ograničio potencijalni uticaj phishing napada. Dva najvažnija pravila su korišćenje jedinstvenih lozinki za svaku uslugu i omogućavanje 2FA.
...
Pored ovih mera, korišćenje dobrog menadžera lozinki kao ekstenzije za pregledač takođe može da vas zaštiti od lažnih veb-sajtova. Naime, većina ovih ekstenzija će detektovati sumnjiv URL i odbiti da automatski popuni vaše akreditive, ili će vas čak obavestiti o tome, što će vas sprečiti da nenamerno izložite svoje pristupne podatke.
...
Phishing funkcioniše samo ako kliknete prebrzo. Za svaki link koji primite, razvijte naviku sistematskog proveravanja, čak i za sajt koji poznajete. Odvajanje vremena za pažljivo ispitivanje i proveru URL-ova, čak i onih poznatih, jedna je od najboljih odbrana protiv ove vrste napada.



### Proveri instalirane ekstenzije



Ekstenzije pregledača su moduli koji dodaju funkcije (blokiranje oglasa, prevođenje, vođenje beležaka, menadžer lozinki, Bitcoin novčanici, itd). One rade direktno u okruženju pregledača i mogu pristupiti svim ili delovima stranica koje posećujete. Ovo ih čini moćnim, ali i potencijalno opasnim.



Zlonamerna ili kompromitovana ekstenzija može presresti vaše lične podatke, pročitati sadržaj, ubaciti kod u veb stranice ili čak izvršiti JavaScript u pozadini. Neke ekstenzije zadržavaju trajni pristup otvorenim karticama ili istoriji pretraživanja, daleko iznad onoga što je potrebno za njihovo funkcionisanje.
...
Redovno proveravanje vaših ekstenzija je važan deo održavanja sigurnosti vašeg pregledača.
...
Kompartmanizacija aktivnosti je važna praksa za ograničavanje obima kompromitovanja na vebu. Sastoji se u tehničkom odvajanju različitih načina korišćenja interneta: lično, profesionalno, privatno ili osetljivo pretraživanje.



Cilj je jednostavan: sprečiti da incident koji uključuje određenu aktivnost (kao što je curenje kolačića, napad ili krađa sesije) kontaminira vaše celokupno digitalno okruženje. Može se koristiti nekoliko metoda, pojedinačno ili u kombinaciji:
...
Moderni pregledači omogućavaju sajtovima da zatraže pristup osetljivim resursima na vašem uređaju, kao što su kamera, mikrofon, geolokacija ili sistemske notifikacije. Ove funkcije su korisne za određene aplikacije (video konferencije, interaktivne mape...), ali takođe otvaraju vrata zloupotrebama ako nisu dobro kontrolisane.



Kada vam sajt zatraži pristup jednom od ovih resursa, pregledač prikazuje iskačući prozor koji morate prihvatiti. Međutim, ako ga jednom prihvatite nesvesno, ova dozvola može ostati trajno aktivna za sve vaše buduće posete tom sajtu. To znači, na primer, da sajt može ponovo aktivirati vaš mikrofon ili kameru bez da vas pita, ako ručno niste opozvali ovo pravo.
...
- Dodeli dozvole samo kada su strogo potrebne za legitimnu funkciju;
- Preferirajte opciju "dozvoli jednom" ako je dostupna;
- Ručno opozovite dozvole dodeljene putem postavki pregledača redovno.
...
### Proverite sigurne veze (HTTPS)



Kad god unosite lične, poverljive ili finansijske informacije na neku veb stranicu, bilo da je to lozinka, broj kreditne kartice ili jednostavan obrazac za registraciju, važno je osigurati da je veza između vašeg pregledača i sajta šifrovana.
...
Nasuprot tome, ako sajt i dalje koristi HTTP (bez "S"), veza je nešifrovana. Bilo koja uneta informacija može biti presretnuta od strane zlonamernog aktera koji se nalazi između vas i sajta: operater mreže, provajder pristupa, zamka u obliku Wi-Fi pristupne tačke, lokalni malver, itd.



U teoriji, uvek bi trebalo ručno proveriti ove informacije pre unosa podataka na veb-sajt. U praksi, većina modernih pregledača automatski označava HTTP sajtove kao nesigurne. Takođe možete aktivirati opciju da forsirate korišćenje HTTPS protokola u bezbednosnim podešavanjima vašeg pregledača, omogućavajući vam da blokirate sajtove koji ga ne podržavaju.
...
Dakle, pretraživač kao što je Google pruža brze, relevantne rezultate (iako [neke studije sugerišu](https://consumerwatchdog.org/in-the-news/Wallet-hub-google-quality-issues-part-of-an-intentional-strategy/) da Google postaje sve manje efikasan), ali po cenu sistematskog praćenja vaših upita. Bing (Microsoft) i Yahoo slede sličan model prikupljanja vaših online aktivnosti kako bi napajali svoje oglasne mreže.



Da biste ograničili ovo praćenje, preporučujemo odabir pretraživača koji poštuju privatnost i ne čuvaju nikakve lične identifikatore ili vašu istoriju pretrage:
...
- [SearXNG](https://docs.searxng.org/) (koji se može samostalno hostovati).
...
U većini pregledača možete ručno konfigurisati podrazumevani pretraživač u podešavanjima. Ovo vam omogućava da izbegnete Google bez promene pregledača.



Najbolje prakse predstavljene u ovom poglavlju čine osnovu za sigurnije, suvereno pretraživanje. Ako ih redovno primenjujete, značajno ćete smanjiti izloženost pretnjama.



Sada kada smo pogledali upotrebu pretraživača i računara, u sledećem delu ćemo istražiti kako povratiti kontrolu nad našim mobilnim telefonom.
...
# Preuzimanje kontrole nad svojim telefonom


<partId>5f0ef9ad-5701-4620-89bf-eb6937adccac</partId>


## Mobilni operativni sistemi: Razumevanje problema


<chapterId>020329e9-a2cb-464b-bb4c-ee4f0e5346c6</chapterId>


Do sada smo se uglavnom fokusirali na obezbeđivanje i korišćenje vašeg računara. Međutim, za većinu ljudi, pametni telefon je sada najčešće korišćen digitalni uređaj u svakodnevnom životu.


Za razliku od računara, mobilni telefoni uglavnom rade na zatvorenim sistemima, koji su strogo kontrolisani od strane njihovih proizvođača. Stoga, u ovom delu predlažem da istražimo specifične izazove vezane za mobilne operativne sisteme.


### Android: Od otvorenog koda do Google kontrole


#### Kratka istorija Androida
...
*Izvor : [By Akela NDE - Vlastiti rad](https://commons.wikimedia.org/w/index.php?curid=6680413), CC BY-SA 3.0*


Međutim, ovu početnu otvorenost Google će postepeno ograničiti. Uz AOSP open-source kod, kompanija razvija paket vlasničkih aplikacija i API-ja, grupisanih pod nazivom *Google Mobile Services (GMS)*. Ovi će postepeno uključivati Play Store, Google Maps, YouTube, Google Play Services, Gmail, Chrome i Voice Assistant. Da bi mogli unapred instalirati Play Store, proizvođači sada moraju potpisati licencni ugovor sa Google-om i garantovati kompatibilnost svojih uređaja sa GMS standardima, što ozbiljno ograničava njihove mogućnosti za prilagođavanje.


Android je doživeo brz uspon: pretekao je iOS po tržišnom udelu već u julu 2011. godine, i postao dominantni mobilni operativni sistem u junu 2012, nakon iznenadnog kolapsa SymbianOS-a kada ga je Nokia napustila u korist Windows Phone-a. Android je od tada ostao neprikosnoveni lider mobilnog tržišta, i danas čini duopol sa iOS-om.
...
- obavezna integracija nekoliko Google aplikacija kao sistemskih aplikacija koje se ne mogu deinstalirati
- vizuelno isticanje određenih aplikacija (Google Search, Play Store, Gemini, itd.) na početnom ekranu
- isključiva upotreba Google API-ja za važne funkcije kao što su sinhronizacija, push obaveštenja i geolokacija
...
### iOS: visoka sigurnost, ali zatvoren sistem
...
iOS je inicijalno bio zasnovan na operativnom sistemu koji koristi Mac: OS X. Koristi hibridno jezgro izvedeno iz Darwina, koji je sam izveden iz BSD Unix-a i Mach mikrokernela. Ova tehnička osnova omogućava iOS-u da nasledi niz svojstava robusnosti i stabilnosti specifičnih za Unix sisteme. Sistem je stoga dizajniran oko strogih sigurnosnih principa, uključujući:
...
Ova zatvorena arhitektura omogućava Apple-u da garantuje fluidno i sigurno korisničko iskustvo. Centralizovani razvoj takođe olakšava optimizaciju hardvera i softvera, sa malo varijabilnosti između modela, za razliku od Androida. iOS se stoga smatra jednim od najsigurnijih sistema protiv računarskih napada.


#### Nedostaci zatvorenog iOS-a
...
Instalacija zahteva otključavanje bootloader-a, operaciju koja omogućava pisanje nove sistemske slike, ali koja potpuno briše sadržaj originalnog uređaja. Dodatne usluge, kao što su F-Droid ili Aurora Store za aplikacije, takođe će morati biti ručno instalirane.


Neki proizvođači zabranjuju ili komplikuju ovu operaciju, ili čak deaktiviraju određene funkcije (kamera, senzori, itd.) prilikom promene sistema. Zato je važno odabrati kompatibilan telefon (često Google Pixel).
...
[GrapheneOS](https://grapheneos.org/) je unapređeni AOSP ROM, dizajniran da ponudi viši nivo bezbednosti od standardnog Androida. Razvija ga nezavisni tim i revidiran je od strane stručnjaka. Graphene implementira napredne bezbednosne mehanizme, uključujući:



- drastično smanjenje površine napada: podrazumevano onemogućavanje mnogih funkcija (NFC, Bluetooth, itd.), zaključavanje USB portova kada je uređaj neaktivan, napredna kontrola pogo pinova, itd.
- jači Android sandbox
- napredna zaštita memorije
- granularna kontrola dozvola
- hardverska enkripcija nezavisna od Google-a
- itd.
...
### Koji operativni sistem za pametne telefone za koju upotrebu?


Kada birate operativni sistem za svoj pametni telefon, morate biti svesni kompromisa između bezbednosti, privatnosti, jednostavnosti korišćenja i kompatibilnosti aplikacija. Svako rešenje ima specifične tehničke karakteristike koje će direktno uticati na vaše svakodnevno iskustvo, vaše mogućnosti kontrole i vašu izloženost komercijalnom nadzoru ili ranjivostima.
...
U prethodnom poglavlju analizirali smo probleme povezane sa operativnim sistemima pametnih telefona i istražili razne alternative za postizanje veće kontrole nad vašim telefonom. Ali odabir dobrog operativnog sistema nije dovoljan: da biste osigurali pravu sigurnost i poverljivost, važno je usvojiti nekoliko dobrih praksi u svakodnevnoj upotrebi.


U ovom poglavlju, korak po korak ćemo razmotriti neke osnovne preporuke koje važe bez obzira na operativni sistem vašeg pametnog telefona.
...
Međutim, neki brendovi imaju veoma dobru softversku podršku, posebno Google (7 godina), Fairphone (5 do 7 godina), Samsung (5 do 7 godina) i Apple (5 do 7 godina). Ovaj kriterijum je veoma važan prilikom kupovine novog telefona: Trajan uređaj je pre svega održavan uređaj.
...
Na Androidu, alternativne prodavnice otvorenog koda kao što je [F-Droid](https://f-droid.org/) nude etičnije i često sigurnije rešenje: svaka aplikacija je kompajlirana iz slobodnih izvora i ručno proverena. Za neophodne vlasničke aplikacije, alati kao što je [Aurora Store](https://auroraoss.com/) omogućavaju pristup Play Store-u bez Google naloga, što ograničava prikupljanje podataka.
...
Neki sistemi takođe vam omogućavaju da automatski opozovete autorizacije date aplikaciji nakon određenog perioda nekorišćenja. Ovo ograničava rizike ako zaboravite da deinstalirate aplikaciju.


### Zaključavanje ekrana


Fizička sigurnost pametnog telefona počinje sa njegovim zaključanim ekranom. Ovo je prva barijera između potencijalnog napadača i pristupa vašim ličnim podacima. Najpouzdanije sredstvo je i dalje PIN kod ili složena lozinka.


S druge strane, metode otključavanja kao što su grafičke šeme se snažno ne preporučuju. Takve šeme ostavljaju vidljive tragove na ekranu, lako ih je zapamtiti za treću stranu koja posmatra vaš gest i retko su dovoljno složene.
...
Za osetljive uređaje, najbolje rešenje je lozinka u kombinaciji sa biometrijskom deaktivacijom, sa isključivo ručnim otključavanjem. Ovo može delovati restriktivno, ali je najbolji način da se obezbedi zaštita. Očigledno, za PIN kod ili alfanumeričku lozinku, što duža i nasumičnija, to bolje. Takođe mora biti otporna na napade grubom silom.


### Korišćenje i segmentacija podataka


Kao što smo videli u prethodnim poglavljima, kompartmenalizacija je važna praksa za ograničavanje rizika u slučaju kompromitovanja jednog dela sistema. Kreiranjem odvojenih okruženja za vaše različite aktivnosti, sprečavate napad ili curenje podataka u jednom području da kontaminira ceo vaš uređaj. Na Androidu, ova strategija se može implementirati kroz niz ugrađenih mehanizama.
...
Alat Shelter je aplikacija otvorenog koda koja koristi ovu funkciju *Work Profile* Android sistema kako bi ponudila neprofesionalnim korisnicima jednostavan način za kreiranje izolovanog okruženja. Shelter se može koristiti za instaliranje i pokretanje osetljivih aplikacija u zaštićenom prostoru, što značajno smanjuje njihovu izloženost drugom softveru instaliranom na telefonu.


![Image](assets/fr/144.webp)


#### Koristite nekoliko odvojenih telefona


Da bi se razdvajanje upotreba dodatno unapredilo, moguće je odlučiti se za korišćenje nekoliko fizičkih uređaja, od kojih je svaki posvećen različitoj vrsti aktivnosti (lična, profesionalna ili osetljiva). Ovo fizičko razdvajanje obezbeđuje potpunu izolaciju, mnogo strožu od softverske segmentacije, jer svaki telefon funkcioniše potpuno nezavisno.


Ako je jedan pametni telefon ugrožen, ostali ostaju netaknuti. Ovo fizičko razdvajanje takođe ima prednost u pojednostavljivanju upravljanja pristupom i dozvolama na svakom uređaju, i smanjuje ukupnu izloženost potencijalnim pretnjama.


### Kontrolišite tokove podataka


Vaš pametni telefon je u stalnoj komunikaciji sa spoljnim svetom, bilo putem Wi-Fi, Bluetooth, NFC, GPS ili mobilnih mreža. Svaki od ovih kanala predstavlja potencijalnu površinu za napad. Razumevanje kako oni funkcionišu i njihovo obezbeđivanje je stoga važno za ograničavanje rizika.
...
Pametni telefoni su u stalnoj komunikaciji sa baznim stanicama telefonskih operatera. Ovu komunikaciju mogu presresti određeni *IMSI Catchers*, koji simuliraju bazne stanice kako bi presreli vaše mobilne podatke. Ovi napadi omogućavaju trećoj strani da identifikuje vaš uređaj, prati vaše kretanje i, u nekim slučajevima, presreće pozive i poruke.


![Image](assets/fr/145.webp)


Neke aplikacije, kao što je SnoopSnitch na Androidu, mogu otkriti sumnjivo ponašanje u vašim razmenama sa mrežom. Ovi alati analiziraju metapodatke mobilnih komunikacija i mogu vas upozoriti na promene u radio konfiguraciji ili abnormalno ponašanje, čineći vas opreznijim protiv pokušaja presretanja.


Najbolji način da osigurate svoje komunikacije je korišćenje sigurnih aplikacija za razmenu poruka, bilo za pozive ili poruke. Ove aplikacije ne koriste mobilnu mrežu i osiguravaju da su razmene pravilno šifrovane. O ovoj temi ćemo detaljnije govoriti u narednom poglavlju.


### Osiguravanje vašeg mobilnog uređaja
...
Njihova stvarna korisnost je stoga veoma ograničena, a ove aplikacije su ponekad skupe, nepotrebno trošeći bateriju i resurse. Bolje je ne koristiti ih, već jednostavno usvojiti najbolje prakse predstavljene u ovom poglavlju.
...
### Sigurnosna kopija i upravljanje u slučaju gubitka


#### Šifrujte svoje rezervne kopije
...
U današnjem povezanom svetu, značajan deo naših ličnih, profesionalnih i osetljivih razmena odvija se putem elektronskih poruka. Međutim, poverljivost ovih komunikacija u velikoj meri varira u zavisnosti od korišćenih protokola.


U ovom poglavlju pokušaćemo da razumemo tehnička i praktična pitanja koja su uključena u korišćenje alata za digitalnu komunikaciju, kako bismo izabrali i koristili one koji pružaju stvarnu zaštitu od prisluškivanja i nadzora.
...
- od strane operatera
- od strane zlonamernog aktera koji presreće mobilni saobraćaj (npr. putem IMSI hvatača)
- ili od strane vladinih agencija sa legalnim ili ilegalnim pristupom mrežnim infrastrukturama


Činjenica da se SMS poruke čuvaju na centralnim serverima operatera, kao i slabost sistema autentifikacije (telefonski broj kao jedinstveni identifikator), čine poruke lako presretnutim i ranjivim na napade. SMS je stoga potpuno nepodoban za prenos informacija, bilo u ličnom, profesionalnom ili kritičnom kontekstu.


Ova ograničenja se takođe primenjuju na MMS (*Multimedia Messaging Service*), koji se zasniva na istim tehničkim osnovama, uz dodatak multimedijalnog sadržaja (fotografije, video zapisi).


U poslednjih nekoliko godina, neki operateri i proizvođači su uveli RCS (*Rich Communication Services*), tehničku evoluciju SMS-a. RCS omogućava slanje obogaćenih poruka (slike, video zapisi, potvrde o prijemu, itd.) i integriše tranzitnu enkripciju (TLS), ali to ostaje zavisno od serverskih operatera i ne garantuje enkripciju od kraja do kraja u svim slučajevima. Štaviše, fragmentacija njegove implementacije između operatera i proizvođača (između Androida i iOS-a, na primer) ograničava njegovo usvajanje i stvarnu pouzdanost.
...
### Sigurno slanje poruka: koja su rešenja?


Suočeni sa ograničenjima SMS-a, pojavile su se brojne moderne aplikacije, neke sa end-to-end enkripcijom. Evo komparativnog pregleda glavnih aplikacija dostupnih danas, kako biste identifikovali one koje najbolje zadovoljavaju vaše potrebe za sigurnošću i poverljivošću.
...
WhatsApp, u vlasništvu kompanije Meta (ranije Facebook), takođe koristi *Signal Protocol* za svoju end-to-end enkripciju. Dakle, u teoriji, vaši WhatsApp razgovori su efikasno zaštićeni od presretanja. Međutim, to nije nužno najbolje u smislu stvarne poverljivosti: aplikacija prikuplja ogromnu količinu metapodataka (brojevi, učestalost razmene, približna lokacija, kontakti...), što Meta može komercijalno iskoristiti za reklamne ili analitičke svrhe.


Takođe, enkripcija koju primenjuje WathsApp ne može biti verifikovana, jer je njegov izvorni kod vlasnički. Zato ne preporučujem korišćenje WhatsApp-a u kontekstu gde su poverljivost i sigurnost vaših razmena važni.


#### Telegram


Telegram je veoma popularna usluga za razmenu poruka zahvaljujući svojoj ergonomiji i funkcijama (javnim kanalima, botovima, velikim grupama...). Međutim, njegova sigurnost je po defaultu mnogo ograničenija: samo "tajne razmene" imaju koristi od end-to-end enkripcije. Sve ostale konverzacije (većina svakodnevnih razmena korisnika) se čuvaju nešifrovane na Telegramovim serverima.
...
Threema, pokrenuta u Švajcarskoj 2012. godine, izdvaja se od većine drugih sigurnih servisa za razmenu poruka zahvaljujući pristupu privatnosti po dizajnu. Za razliku od Signala, WhatsAppa ili Telegrama, nije potreban broj telefona za kreiranje naloga. Korisniku se dodeljuje jedinstveni nasumični identifikator, omogućavajući potpuno anonimnu registraciju bez direktne veze sa stvarnim identitetom.
...
SimpleX Chat, pokrenut 2021. godine, potpuno eliminiše pojam korisničkog ID-a: nema broja telefona, nema javnog pseudonima, nema vidljivog javnog ključa. Svaki korisnik je identifikovan isključivo putem linkova ili efemernih QR kodova. Ova arhitektura čini korelaciju između korisnika praktično nemogućom, garantujući visok nivo poverljivosti.


![Image](assets/fr/151.webp)


Tehnički, poruke su šifrovane od kraja do kraja i prolaze kroz relej servere. Ovi releji nemaju informacije o pošiljaocu, primaocu ili njihovim ključevima. Kada je poruka preneta, odmah se briše sa servera. SimpleX usvaja nefederisanu, decentralizovanu arhitekturu: serveri ne dele globalni direktorijum, i svaki korisnik može instalirati svoj sopstveni relej. Ovo je u suprotnosti sa rešenjima kao što je Matrix, gde federisani serveri prate razmene.
...
K-9 Mail je open-source Android klijent za e-poštu, nedavno integrisan u Mozilla Thunderbird ekosistem. Podržava više naloga, PGP enkripciju putem OpenKeychain-a i radi bez posredničkog servera.
...
Proton Mail je sigurna švajcarska usluga za razmenu poruka koja nudi end-to-end enkripciju između Proton korisnika. Mobilna aplikacija je open-source, bez reklama i ne prikuplja lične podatke prilikom registracije. Proton Mail podržava samo Proton naloge, ali omogućava slanje enkriptovanih poruka čak i na spoljne adrese putem lozinke.
...
Većina klasičnih aplikacija za mapiranje, kao što su Google Maps, Waze ili Citymapper, prikupljaju veliku količinu ličnih podataka. Beleže vaše kretanje, pretrage i navike, i koriste ih u komercijalne svrhe.
...
Besplatna verzija je već veoma bogata, a plaćena verzija vam omogućava da otključate još više funkcija i podržite projekat.
...
ONLYOFFICE je kancelarijski paket otvorenog koda. Omogućava vam da otvorite i uređujete Word, Excel i PowerPoint dokumente direktno na vašem mobilnom uređaju, čak i lokalno. Takođe ga možete povezati sa raznim cloud servisima za automatsku sinhronizaciju, kao što je Nextcloud.
...
Nextcloud je rešenje za lični oblak otvorenog koda koje možete sami hostovati ili koristiti putem pouzdanog provajdera. Omogućava vam da sinhronizujete, delite i uređujete svoje fajlove sa pametnog telefona, uz zadržavanje potpune kontrole nad njihovim skladištenjem.


Na Androidu, možete instalirati zvaničnu Nextcloud mobilnu aplikaciju da pristupite svom ličnom oblaku sa bilo kog mesta. Takođe možete dodati funkcije kao što su upravljanje fotografijama, kancelarija, kalendar i razmena poruka.
...
Mnogi ljudi koriste aplikacije kao što su Google Calendar ili Outlook Calendar za upravljanje svojim sastancima. Ipak, ove usluge su povezane sa centralizovanim online nalozima koji prikupljaju podatke o vašim navikama, lokacijama sastanaka i interakcijama.
...
Etar je jednostavan, efikasan i potpuno open-source kalendar. Može raditi lokalno, ali takođe omogućava sinhronizaciju putem CalDAV-a, standardnog protokola za sinhronizaciju kalendara sa servisima koji poštuju privatnost (kao što su Nextcloud ili EteSync).
...
Ova aplikacija je deo paketa "*Simple Mobile Tools*". Ne zahteva nalog ili pristup mreži, što je čini idealnom za potpuno vanmrežnu upotrebu. Možete dodavati događaje, postavljati podsetnike i organizovati prikaze po danu, nedelji ili mesecu. Kao i ostatak paketa, Simple Calendar je bez reklama, bez praćenja i 100% otvorenog koda.
...
Aplikacije kao što su Evernote, Google Keep ili OneNote koriste se za beleženje ideja, organizovanje zadataka ili čuvanje lista. Međutim, sve one se oslanjaju na vlasničke onlajn servise, koji centralizuju vaše podatke na svojim serverima i često analiziraju vaš sadržaj u komercijalne svrhe.
...
Jednostavna vremenska aplikacija, zasnovana na OpenWeatherMap, otvorenog koda, podesiva, sa widgetima.
...
NewPipe je još jedan alternativni YouTube klijent. Lagan, bez reklama, bez praćenja i potpuno otvorenog koda, omogućava vam da gledate, preuzimate ili slušate video zapise sa YouTube-a (i drugih platformi kao što su SoundCloud ili PeerTube) u pozadini. Nije potrebna veza sa Google-om. NewPipe radi potpuno nezavisno od zvanične YouTube aplikacije i ne zahteva nikakvu Google uslugu za rad.
...
Popularni VLC media player dostupan je i na Androidu. Podržava širok spektar audio i video formata i omogućava vam reprodukciju datoteka lokalno ili preko mreže, sve bez reklama ili prikupljanja podataka. To je odlično rešenje za upravljanje vašom multimedijalnom bibliotekom lokalno, bez povezivanja sa uslugom treće strane.
...
Funkwhale je decentralizovana platforma za deljenje i slušanje muzike, sa kompatibilnim klijentima.


### Tastatura


Virtuelne tastature kao što su Google-ov Gboard ili Microsoft-ov SwiftKey su sveprisutne na pametnim telefonima. Međutim, one predstavljaju velike rizike po privatnost: Svaki karakter koji se otkuca može teoretski biti zabeležen, analiziran ili prenet na udaljene servere. Čak i ako ove kompanije tvrde da anonimizuju podatke, prikupljanje je i dalje moguće.
...
FlorisBoard nudi moderniji, modularni pristup. Takođe je open-source i integriše napredne funkcije kao što su unos gestovima, personalizovani raspored tastera i višejezično upravljanje. Sva obrada podataka se vrši lokalno, bez povezivanja sa spoljnim serverima. FlorisBoard je još uvek u razvoju, ali je već potpuno upotrebljiv na dnevnoj bazi za one koji žele moćnu tastaturu bez žrtvovanja privatnosti.
...
OpenCalc je brz i jednostavan za korišćenje kalkulator otvorenog koda, savršeno prilagođen svakodnevnim potrebama. Ne prikuplja podatke i radi potpuno van mreže, bez reklama ili zavisnosti od bilo koje spoljne usluge.
...
Aplikacija Google News, iako praktična i personalizovana, oslanja se na sistematsku analizu vaših interesa, istorije pretraživanja i navika čitanja kako bi poboljšala svoje preporuke. Ovo uključuje opsežno prikupljanje ličnih podataka, koji se često koriste u svrhe oglašavanja.
...
Aplikacija *News*, koju je razvio Bubelov, nudi radikalno drugačiji pristup. To je minimalistički RSS čitač, dizajniran za pregledanje vesti bez trackera, reklama ili nejasnih algoritama preporuka. Možete ručno odabrati svoje izvore (štampa, blogovi, podcasti, nezavisni mediji, itd.), garantujući neutralno, privatno iskustvo čitanja. Dizajn je čist, feedovi se automatski ažuriraju, a podaci se ne prenose trećim stranama.
...
Ente Photos je open-source usluga (klijenti + serveri) za automatsko pravljenje rezervnih kopija fotografija sa end-to-end enkripcijom. Vaše slike su šifrovane na uređaju pre nego što budu poslate, što osigurava da čak ni Ente serveri ne mogu da im pristupe. Ente takođe nudi verziju za samostalno hostovanje za napredne korisnike.
...
MJ PDF Reader je jednostavna, open-source aplikacija koja vam omogućava čitanje PDF fajlova bez reklama ili povezivanja na online nalog.


### Telefon


Googleova aplikacija Phone, instalirana po defaultu na mnogim Android pametnim telefonima, radi efikasno, ali prikuplja značajnu količinu podataka o korišćenju.
...
Yuka se široko koristi za skeniranje prehrambenih i kozmetičkih proizvoda i procenu njihovog kvaliteta, ali se oslanja na netransparentan model, sa upitnim kriterijumima ocenjivanja, delimično vlasničkom bazom podataka i aplikacijom koja nije otvorenog koda. Štaviše, njen rad zahteva povezivanje sa centralizovanim serverom, uz potencijalno prikupljanje podataka o korišćenju.
...
OpenFoodFacts je mnogo transparentnija i privatnosti prijatnija alternativa. Ovaj kolaborativni open-source projekat nudi globalnu bazu podataka, koju doprinose korisnici. Informacije o nutritivnim vrednostima, sastojcima i etiketama mogu se pristupiti transparentno, bez zloupotrebe prikupljanja podataka.
...
Quick Share je sada standard na Androidu. Ovaj softver, koji je prvobitno razvio Samsung, ujedinjen je 2024. godine sa Nearby Share od strane Google-a, što je rezultiralo jedinstvenom aplikacijom za deljenje fajlova na Androidu.
...
Snapdrop je besplatna, open-source alternativa koja ne zahteva instalaciju. Omogućava vam deljenje fajlova između uređaja povezanih na istu lokalnu mrežu, jednostavno putem web pregledača. Prenos je direktan (peer-to-peer) i podaci nikada ne prolaze kroz udaljeni server.


Zanimljiva alternativa je [PairDrop](https://github.com/schlagmichdoch/pairdrop) (Fork od Snapdrop), koji nudi nekoliko dodatnih funkcija.
...
Openreads je open-source alternativa za praćenje čitanja koja poštuje privatnost. Ova aplikacija vam omogućava da kreirate ličnu digitalnu biblioteku, pratite svoj napredak u čitanju, ocenjujete i komentarišete knjige, i pristupate preporukama na osnovu sopstvenih kriterijuma, bez centralizovane analize ili praćenja. Svi podaci ostaju na vašem uređaju ili se sinhronizuju putem samostalno hostovanih servisa.


### Sat, alarmi i tajmeri
...
⚠️ ***Oprez**: Iako su alternative predstavljene u ovom poglavlju uglavnom open-source i orijentisane na privatnost, nisu bez svojih ograničenja ili rizika. Neke mogu prestati da se održavaju, imati neispravljene ranjivosti, postati vlasničke ili čak, potencijalno, biti malver. Neke takođe mogu biti ilegalne u vašoj lokalnoj jurisdikciji. Ovo poglavlje sam napisao u junu 2025. godine, ali situacija za ove aplikacije mogla je da se promeni od tada.*


Štaviše, lično nisam pregledao kod svih pomenutih alata, i moje preporuke ni na koji način ne treba smatrati apsolutnim garancijama. Stoga je važno da svako uradi sopstveno istraživanje pre korišćenja ovih aplikacija.


___


# Osiguranje vaše lokalne mreže


<partId>23e49e48-34c9-435c-a36f-1c86b0254275</partId>


## Bolje razumite svoju kućnu mrežu
...
Istorija interneta seže do kasnih 1960-ih, u kontekstu naučnih i vojnih istraživanja. Inicijalni projekat, nazvan "ARPANET", pokrenula je američka agencija ARPA (sada DARPA) kako bi međusobno povezala nekoliko istraživačkih centara i omogućila deljenje resursa.
...
Ovaj uređaj kombinuje 2 glavne funkcije:
...
Wi-Fi (skraćeno od "*Wireless Fidelity*") je tehnologija bežične komunikacije koja vam omogućava da povežete svoje uređaje na lokalnu mrežu, bez potrebe za kablom. Ova tehnologija se zasniva na prenosu podataka putem radio talasa, uglavnom u frekvencijskim opsezima od 2.4 GHz i 5 GHz (ili čak 6 GHz za Wi-Fi 6E i Wi-Fi 7 mreže).


Ali ova jednostavnost korišćenja dolazi sa sopstvenim rizicima. Za razliku od žičanih veza (kao što je Ethernet), Wi-Fi signali prodiru kroz zidove i mogu se primiti sa desetina metara udaljenosti. To znači da ljudi izvan vašeg doma (na ulici, u susednoj zgradi, čak i iz vozila parkiranog u blizini) mogu pokušati da detektuju vašu mrežu i povežu se na nju ako nije pravilno osigurana.
...
- `192.168.0.0` do `192.168.255.255` (generalno za privatne korisnike)
- `10.0.0.0` do `10.255.255.255` (generalno za kompanije)
...
- Port `80` se koristi za pristup HTTP web stranicama
- Port `443` se koristi za pristup HTTPS veb stranicama (šifrovana veza)
- Port `22` se koristi za SSH konekcije
- Portovi `25`, `465` i `587` koriste se za slanje e-mailova (SMTP)
- Port `110` se koristi za preuzimanje e-mailova putem POP3 protokola
- Port `143` se koristi za preuzimanje e-mailova putem IMAP protokola
- Port `21` se koristi za prenos datoteka putem FTP protokola
- Port `53` se koristi za DNS upite...


Ovi portovi se takođe koriste u sistemima kao što su Bitcoin ili Tor, gde se specifični portovi koriste po defaultu za peer-to-peer komunikacije ili usmeravanje saobraćaja:
...
Kao što smo otkrili u prethodnom poglavlju, obezbeđivanje vaše kućne mreže je veoma važno za zaštitu vaše privatnosti, vaših ličnih podataka i za garantovanje vaše digitalne suverenosti.
...
Ruter je srce vaše kućne mreže. Njegova konfiguracija igra važnu ulogu u bezbednosti svih povezanih uređaja. Nažalost, mnoge funkcije koje su podrazumevano aktivirane na ovim uređajima mogu nenamerno izložiti vašu mrežu spoljnim napadima. Zato je važno izvršiti potpunu reviziju aktiviranih opcija i onemogućiti one koje nisu strogo neophodne za vaše potrebe.


Neke funkcije treba izbegavati ili sistematski deaktivirati:
...
Wi-Fi mreža je često preferirana tačka ulaska za upade u domaće okruženje. Nevidljiva golim okom, ali dostupna izvan zidova vašeg doma, laka je meta za svakoga ko je u dometu.
...
U konkretnim terminima, evo nekoliko primera segmentacije koje biste mogli da uradite:
...
Zatim, aktivirajte protokol za šifrovanje DNS upita kako biste sprečili presretanje ili nadgledanje DNS upita. Postoje 2 glavna protokola za to:
