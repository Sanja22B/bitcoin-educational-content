...
---
# Nastartujte cestu své společnosti v síti Bitcoinjlkjkl
...
Další zásadní výhodou měny je její schopnost **umožnit odloženou výměnu**. Při barterové směně jsou transakce okamžité; jedno zboží se vyměňuje za jiné v reálném čase. Měna však umožňuje **spoření - jednotlivci mohou ukládat hodnotu pro budoucí použití**. To představuje obrovský skok vpřed pro ekonomické plánování, investice a hromadění majetku, což vše zlepšuje život účastníků sítě.
...
Jednoduchý případ použití ilustruje, jak se všechny tyto prvky spojují. Představte si místního řemeslníka, který prodává domácí džemy na sobotním farmářském trhu. Vyzbrojen telefonem s opatrovnickou peněženkou Lightning nastaví cenu každé sklenice v eurech; když zákazník požádá o platbu v bitcoinech, obchodník rychle zadá odpovídající fiat částku a aplikace automaticky vypočítá dlužné saty. Výsledný QR kód naskenuje peněženka zákazníka, platba je během několika sekund vypořádána a řemeslník okamžitě ví, že transakce proběhla úspěšně. Na konci dne lze veškeré podrobnosti o transakci exportovat pro evidenci a zůstatek dne lze zcela nebo zčásti odeslat na směnárenskou platformu ke konverzi na fiat měnu.

Díky vyváženosti uživatelsky přívětivých nástrojů, minimálních hardwarových požadavků a jednoduchého vedení záznamů poskytují řešení Starter to nejdůležitější, aniž by zahltila začínající firmy. Pokud se objem transakcí zvýší a provozní požadavky podniku se vyvinou, přechod na pokročilejší kategorie popsané v následující kapitole se stane přirozeným krokem.

Podrobné návody na doporučené peněženky a základní nastavení najdete v následujících průvodcích:
...
Profil Essential je vhodný pro malé a střední podniky, případně se zaměstnanci, které chtějí snadno a rychle přijímat bitcoiny, aniž by potřebovaly pokročilé technické znalosti, a přitom mít úplnější a profesionálnější systém než jednoduchou peněženku. Tato kategorie se nejčastěji týká restaurací, kaváren, barů nebo malých maloobchodů, které měsíčně zaznamenají jen několik plateb bitcoiny, ale přesto si přejí rozhraní, které je jednoduché a zároveň dostatečně robustní, aby zvládlo každodenní provoz bez přerušení.

Na rozdíl od profilu Starter považují základní podniky platby bitcoiny obvykle za trvalou součást svých příjmů, nikoli za pouhý experiment. Stále pracují s relativně nízkými objemy transakcí, ale jejich četnost je dostatečná na to, aby majitelé a zaměstnanci měli prospěch ze strukturovanějšího a spolehlivějšího systému. Profil Essential zároveň zůstává zaměřen na jednoduchost; umožňuje sice praktické ovládací panely a omezenou správu rolí, ale nevyžaduje specializované IT zdroje ani složité integrace.
...
Profil Professional je určen pro podniky, které se již vymanily z příležitostných nebo nízkoobjemových plateb bitcoiny a nyní hledají robustní infrastrukturu pro zpracování mnoha každodenních transakcí. Tyto společnosti často působí v několika kanálech (třeba v maloobchodní prodejně, na specializovaných webových stránkách elektronického obchodu, a dokonce i při mobilním prodeji), a proto vyžadují platební řešení, které lze hladce integrovat do jejich stávajících pracovních postupů. V mnoha případech podniky na této úrovni již spravují systémy pro prodejní místa, platformy pro správu online objednávek a back-office operace, které vyžadují spolehlivý a škálovatelný přístup.
...
Dalším klíčovým aspektem pro uživatele Professional je zabezpečení a správa rolí. S narůstajícím počtem každodenních transakcí s bitcoiny se řízení přístupu k administrativním funkcím stává zásadním opatřením pro zmírnění rizik. V mnoha řešeních mohou správci přidělovat různé úrovně oprávnění (třeba omezit některé zaměstnance na prohlížení historie transakcí a generování faktur, zatímco jiným udělit oprávnění ke správě zásob nebo konfiguraci nastavení celého systému...). Tato hierarchická struktura nejen chrání citlivé údaje, ale také zefektivňuje provoz tím, že vyjasňuje, kteří zaměstnanci mají odpovědnost za jednotlivé segmenty platební infrastruktury.
...
Profil Enterprise představuje vrchol implementací plateb Bitcoin, který je přizpůsoben speciálně pro velké společnosti, velká tržiště a zavedené podniky, které vyžadují plně přizpůsobená řešení. Na rozdíl od nasazení menšího rozsahu nebo střední úrovně integrují operace na úrovni Enterprise platby Bitcoin do široké škály pracovních postupů a systémů, od zařízení na místě prodeje až po webové stránky e-shopů, účetní platformy v zázemí a sofistikované rámce ERP.

V tomto měřítku není hlavním cílem pouze přijímat bitcoiny, ale činit tak způsobem, který je důkladně **sladěn s hlavními procesy organizace**. Toto sladění si může vyžádat vývoj specializovaného softwaru, ať už se jedná o řešení zcela na míru, nebo o řešení organizované prostřednictvím infrastruktury založené na SaaS a podporované třetími stranami *Lightning Service Providers* (LSP). Takoví LSP si poradí s vysokými objemy transakcí a složitými síťovými konfiguracemi, které přesahují kapacitu běžnějších out-of-the-box nástrojů. Výsledná architektura proto zahrnuje širokou škálu technických a obchodních aspektů, od integrací řízených rozhraním API až po pokročilé funkce správy pokladny.
...
V oblasti účetnictví vyžadují vysoce frekventované transakce **přesně přizpůsobené exporty** a někdy i synchronizaci s podnikovým finančním softwarem v reálném čase. Velké podniky se mohou spoléhat na řešení pro plánování podnikových zdrojů (ERP), jako je SAP nebo Oracle, která zase musí být hladce propojena s údaji o platbách v bitcoinech. Aby to bylo možné, musí být rozhraní API zvolené platformy propracované a flexibilní, aby IT týmům poskytlo svobodu vytvářet vlastní dashboardy pro reporting, implementovat automatizované procesy odsouhlasování a generovat denní nebo dokonce hodinové finanční souhrny.

Typický podnikový scénář může zahrnovat velké tržiště elektronického obchodu, které denně přijímá tisíce transakcí. Kromě pouhého uvedení Bitcoinu jako platební možnosti může toto tržiště přizpůsobit každý aspekt uživatelského prostředí, od toho, jak se tok plateb v Bitcoinech zobrazuje na webových stránkách pro zákazníky, až po způsob, jakým jsou na zadní straně spravovány náhrady, zpětné platby nebo řešení sporů. Na průběžnou údržbu, bezpečnostní záplaty a aktualizace v oblasti dodržování předpisů by dohlížel specializovaný tým devops ve spolupráci s finančním a právním oddělením. Pokud by se společnost rozhodla ponechat si část svých příjmů z bitcoinů, interní pokladní systém by vedle tradičních měnových rezerv sledoval i držbu bitcoinů ve firmě.

Pro zajištění hladkého a bezpečného nasazení na podnikové úrovni většina organizací využívá specializované poskytovatele služeb nebo vlastní vývojové týmy se zkušenostmi s integrací Bitcoinů a Lightning Network. Proces obvykle začíná hloubkovým posouzením potřeb (zahrnujícím technickou infrastrukturu, požadavky na dodržování předpisů a požadovanou cestu zákazníka), po němž následuje návrh architektury, která zvládne velkoobjemovou propustnost. V závislosti na rozsahu projektu se můžete spolehnout na multidisciplinární tým složený z finančních kontrolorů, bezpečnostních analytiků a softwarových inženýrů. Alternativně vás může od počáteční koncepce až po konečné zavedení provést rostoucí počet specializovaných poradenských firem, které vám pomohou s úkoly, jako je vyhodnocení řešení hostovaných formou SaaS, konfigurace *Lightning Service Providers* a přizpůsobení front-end rozhraní. Díky spolupráci s odborníky na danou oblast mohou podniky zmírnit rizika spojená s implementací rozsáhlých plateb a dosáhnout řešení, které je nejen robustní a vyhovující, ale také dostatečně flexibilní, aby se přizpůsobilo budoucímu růstu.

## Řešení pro platby bitcoiny: Možnosti a trendy

<chapterId>59ff43a1-98e2-4a81-af3e-9654bdd60952</chapterId>

Pro každou kategorii řešení vždy existují kompromisy. Například v počáteční "zkušební fázi" jsou navrhované peněženky navrženy tak, aby byly co nejjednodušší z hlediska uživatelského rozhraní, ale jsou hostované (**používané**). To znamená, že finanční prostředky jsou pod kontrolou poskytovatele aplikace. Étos Bitcoinu však podporuje přechod k plnému vlastnictví prostředků uživatelem (**self-custodial**). V takovém případě se doporučuje přejít do další kategorie, jakmile dojde k prvním prodejům - v podstatě jakmile se potvrdí, že máte zákazníky ochotné platit v Bitcoinech.

Jednou z klíčových výhod bitcoinu je možnost libovolně přesouvat finanční prostředky, což umožňuje **velmi snadno měnit poskytovatele** nebo součásti řešení. Všechny aplikace a řešení se navíc samy rychle vyvíjejí. Vezměme si například Bitcoinize, která nyní poskytuje fyzický terminál pro prodejní místa (POS), který se integruje s mnoha aplikacemi na trhu, což je řešení, které ještě před několika měsíci neexistovalo.

### Hledáte řešení, jak vytvořit obchod a přijímat tradiční i bitcoinové platby?

Pokud začínáte od nuly - bez obchodu, bez softwaru pro správu produktů a bez pokladního systému - máte několik možností:


- Outsourcing:** Vytvoření webových stránek s nákupními možnostmi a následné přidání možnosti platby bitcoiny můžete zadat externě vedle tradičních řešení v obchodě.
- Jednoduchá řešení:** Můžete také použít platformy, jako je Accessing.app, a udělat to sami. Mezi hlavní výhody patří:
    - Rychlé a cenově dostupné zřízení internetového nebo fyzického obchodu.
    - Vhodné pro sezónní podniky, akce, restaurace nebo maloobchody.
    - Definování a správa produktů pro fyzický i online prodej.
    - Zpracování plateb v měně Fiat (např. eura, dolary) prostřednictvím vlastního účtu Stripe.
    - Zpracování plateb Bitcoin prostřednictvím vlastního účtu SwissBitcoinPay.

### Jak postupuje zavádění bleskových plateb ?

Síť Lightning Network sice nabízí vyšší efektivitu a nižší poplatky, ale její zavádění je teprve v počátcích. Místo toho, abychom se soustředili na současná omezení, stojí za to připomenout si, jak probíhaly historické transformace infrastruktury:


- Když se objevila auta, nebylo jich tolik, aby to ospravedlnilo stavbu silnic, a nebylo jich tolik, aby to ospravedlnilo vlastnictví aut.
- Když byla zavedena elektřina, nebylo dost zákazníků, aby to ospravedlnilo budování rozvodných sítí, a nebylo dost sítí, které by zákazníky přilákaly.

Nové infrastruktury jsou úspěšné, protože jsou efektivnější, a ti, kdo je zavádějí dříve, se k nim připojují, protože z nich mají hmatatelné výhody. Zde jsou postřehy o Lightning Network v roce 2024:


- Velmi rychlé transakce:** Transakce jsou často téměř okamžité (<500 ms) a mají extrémně nízkou míru selhání.
- Profesionalizace sítě:** Větší hráči zajišťují likviditu v celé síti, zatímco jednotlivci z velké části přestali směrovat platby a nyní většinou provozují "okrajové uzly"
- Vylepšený uživatelský zážitek:** Mobilní aplikace pro jednotlivé uživatele se výrazně zlepšily. Funkce, jako je spojování, statické faktury Bolt12 a platby s nulovým potvrzením (0-conf), jsou široce dostupné, takže interakce jsou bezproblémové. Problémy s interoperabilitou (např. vynucené uzávěrky) již nepředstavují hlavní problém.
...
- Metriky sítě:** Celkový počet kanálů a Bitcoinů uzamčených v Lightningu zůstává stabilní, přibližně 20 000 uzlů, 5 200 BTC a 60 000 kanálů. Tento údaj však odráží pouze část sítě a naznačuje střídání účastníků, kdy se zapojuje méně jednotlivců a více profesionálů.
- Lightning jako most mezi sítěmi:** Díky své efektivitě a dostupnosti se Lightning Network již stala mostem mezi ostatními propojenými sítěmi (např. FediMint, Liquid atd.).
...
## Základní zásady pro účetnictví Bitcoin v podnikání

<chapterId>84063061-ffdb-4b1f-b20b-588ffb146877</chapterId>

Následující obsah slouží pouze pro vzdělávací účely a nelze jej považovat za finanční nebo účetní poradenství. Podnikům a jednotlivcům se důrazně doporučuje, aby se před podniknutím jakýchkoli kroků poradili s kvalifikovaným účetním nebo právním odborníkem, který je obeznámen s předpisy o kryptoměnách v jejich konkrétní jurisdikci.

### Klíčové pojmy účtování bitcoinů

**Každá transakce s bitcoiny musí být zaznamenána a může vést ke zdanitelnému plnění**

Bitcoin se v celosvětovém měřítku často neřadí mezi měny, ale mezi digitální aktiva. Toto rozlišení významně ovlivňuje způsob účtování bitcoinů v podnicích, má vliv na daňové povinnosti, finanční výkaznictví a požadavky na dodržování předpisů. Podniky, které přijímají Bitcoin jako platební metodu nebo jej používají jako pokladní nástroj, musí těmto regulačním nuancím rozumět.

Nejdůležitějším důsledkem**, který je třeba mít na paměti, je, že ve většině jurisdikcí vydělávání, prodej, obchodování nebo používání bitcoinů k nákupům obvykle vytváří **zdanitelnou událost** a zisky podléhají dani z kapitálových výnosů.

Dalším aspektem účtování bitcoinů je rozlišování mezi dvěma typy kapitálových zisků:


- Latentní zisky/ztráty:** Nerealizované zisky nebo ztráty vycházející z hodnoty bitcoinů držených na konci účetního období.
- Efektivní zisky/ztráty:** Realizované zisky nebo ztráty při prodeji nebo výměně bitcoinů během fiskálního roku.

Tyto výpočty do značné míry závisí na tom, zda je bitcoin držen pro dlouhodobé investice, nebo pro krátkodobé provozní použití. Kromě toho musí podniky sladit své účetní postupy s místními daňovými strukturami, protože předpisy se v jednotlivých zemích výrazně liší.

Účetnictví pro podniky, které drží bitcoiny, je poněkud těžkopádné, protože každá transakce musí být pečlivě sledována, aby bylo možné vypočítat realizované nebo nerealizované zisky či ztráty. Každý prodej, který uskutečníte přijetím Bitcoinu jako formy platby, nebo každý nákup či prodej Bitcoinu musíte zaznamenat:


- konkrétní čas
- prodejní cena (ve fiat měně)
- pořizovací cena bitcoinu (cena, za kterou byl bitcoin původně pořízen).

To vám později umožní vypočítat rozdíl a určit zisk nebo ztrátu.

**Příklad:** Podnik koupí 1 BTC za 30 000 USD. Později prodá 0,5 BTC za 20 000 USD. Pro výpočet zisku nebo ztráty musí podnik:


- Zaznamenali jste čas, pořizovací cenu fiat a množství získaných bitcoinů
- Zaznamenali jste čas, prodejní cenu fiat a množství prodaných bitcoinů
- Určete cenu prodaných bitcoinů : 0,5 BTC: 30 000 USD ÷ 2 = 15 000 USD.
- Porovnejte prodejní cenu s nákladovou cenou: 20 000 USD (prodejní cena) - 15 000 USD (nákladová cena) = 5 000 USD zisku.
- Aktualizovat držení bitcoinů s novou pořizovací cenou

Tento proces je nutné opakovat pro každou transakci a vzhledem k kolísavé ceně bitcoinu je vedení záznamů ještě obtížnější.

**Jak by to fungovalo, kdyby byl Bitcoin měnou ?**

Pokud by se s bitcoinem zacházelo jako s měnou, podniky by ho ve svém účetním systému spravovaly jako jakoukoli jinou měnu. Namísto sledování pořizovací ceny a realizovaných/nerealizovaných zisků pro každou transakci by se držba bitcoinů jednoduše zaznamenávala na měnový účet. Na konci každého účetního období by se hodnota všech držených měn, včetně Bitcoinu, převedla na účetní měnu (např. USD nebo EUR) pomocí aktuálního směnného kurzu.

**Aktualizovaný příklad, pokud by byl Bitcoin uznán jako měna:**


- Podnik drží 1 BTC, když má Bitcoin hodnotu 30 000 USD. Později podnik použije 0,5 BTC na platbu, když má Bitcoin hodnotu 40 000 USD.
- Podnik **nepočítá** realizovaný zisk nebo ztrátu. Namísto toho je transakce zaznamenána jako:
    - Platba: 20 000 USD (0,5 BTC × 40 000 USD).
    - Zbývající zůstatek bitcoinů: 0.(aktualizováno podle aktuálního směnného kurzu): 5 BTC, nyní v hodnotě 20 000 USD.

**Klíčová výhoda, pokud by byl Bitcoin uznán jako měna:**


- Podnik musí pouze pravidelně upravovat fiat ekvivalent svých držených bitcoinů (např. pro měsíční nebo výroční zprávy), stejně jako v případě eur, jenů nebo jiných měn, které drží.
- Tím se eliminuje potřeba sledování nákladů na úrovni transakcí a zjednodušuje se účetnictví, zejména pro podniky s častými transakcemi s bitcoiny.

Tento přístup by výrazně zjednodušil účtování bitcoinů, snížil administrativní zátěž a sladil zacházení s ostatními měnami za předpokladu, že by bitcoin byl jako takový plně uznán z právního a regulačního hlediska. Tak daleko ještě nejsme.

### Rozdíly mezi individuálním a podnikovým účtováním bitcoinů

Právní a účetní zacházení s bitcoiny se u fyzických a právnických osob výrazně liší. U fyzických osob mohou zisky z transakcí s bitcoiny podléhat dani z příjmu, často s vyšší sazbou. Naproti tomu právnické osoby mohou využívat potenciálně nižší sazby daně z příjmů právnických osob, ale musí dodržovat přísnější účetní standardy.

Pro podniky lze Bitcoin zařadit pod různé účty v závislosti na jeho zamýšleném použití:


- Dlouhodobý majetek:** Pro bitcoiny držené dlouhodobě jako strategická investice.
- Zásoby:** Pro bitcoiny používané ve výrobních procesech (vzácný případ použití, například u profesionálních obchodníků).
- Hotovostní nebo pokladní účty:** Pro bitcoiny držené jako likvidní aktiva, především pro provozní transakce nebo krátkodobé řízení pokladny.

Volba klasifikace závisí na činnosti a strategii společnosti, což má dopad na finanční výkaznictví a daňové povinnosti. Vždy si ověřte místní předpisy, protože tyto klasifikace se mohou v jednotlivých zemích lišit.

### Právní rámec

Právní uznání bitcoinu a zacházení s ním se liší podle jurisdikce. Některé země, například Salvador, uznaly bitcoin jako zákonné platidlo, což zjednodušuje jeho používání v transakcích, ale komplikuje mezinárodní finanční výkaznictví. Jiné země považují Bitcoin za digitální aktivum, na které se vztahují zvláštní daňová a účetní pravidla.

Ve většině zemí je bitcoin klasifikován jako digitální aktivum a zacházení s ním se řídí obecnými účetními standardy. Podniky musí transakce s bitcoiny účtovat následujícím způsobem:


- Účtování kapitálových zisků/ztrát:** Podniky musí ve svých finančních výsledcích účtovat o realizovaných ziscích nebo ztrátách.
- Latentní zisky/ztráty Oceňování:** Nerealizované zisky nebo ztráty se často musí vykazovat, ale nemusí mít přímý dopad na zdanitelný příjem.
- Soulad s účetními standardy:** Podniky musí začlenit transakce s bitcoiny do standardních účetních postupů a zajistit tak transparentnost a přesnost.

Přístup k účtování bitcoinů se liší v závislosti na zeměpisné poloze:


- Spojené státy americké:** Daňový úřad klasifikuje bitcoin jako **majetek, podobně jako akcie, dluhopisy nebo nemovitosti**. Tato klasifikace znamená, že jakákoli transakce s kryptoměnou, jako je její vydělávání, prodej, obchodování nebo dokonce použití k nákupu, může vést ke zdanitelnému plnění a zisky podléhají dani z kapitálových výnosů.
- Evropská unie:** Členské státy obecně považují bitcoin za spekulativní aktivum, nikoli za funkční měnu. Proto zisky často podléhají dani z kapitálových výnosů.
- Asie:** Země jako Singapur a Japonsko přijaly progresivní regulační rámce, které v určitých souvislostech příznivě přistupují k transakcím s bitcoiny. Bitcoin se však obecně účtuje jako **nehmotný majetek** a k datu vykázání se oceňuje reálnou hodnotou, přičemž změny se vykazují ve výkazu zisku a ztráty.

Je nezbytné porozumět předpisům v zemi, kde působíte, a přizpůsobit jim své účetní postupy.

### Výzvy v regulačním vývoji

Rychlé tempo inovací v oblasti kryptoměn často předbíhá regulační rámce. Od uznání bitcoinu jako digitálního aktiva dochází k postupným aktualizacím globálních předpisů, ale mezery přetrvávají:


- Nedostatek judikatury:** Jen málo právních případů objasnilo konkrétní účetní postupy, což ponechává prostor pro výklad.
- Probíhající diskuse:** V mnoha jurisdikcích zůstávají nevyřešeny otázky, jako je daňové zacházení s latentními ztrátami.
- Přeshraniční složitost:** Společnosti působící v mezinárodním měřítku čelí problémům při slaďování různých národních účetních standardů.

Navzdory těmto výzvám poskytují proaktivní postoje mnoha zemí pevný základ pro to, aby podniky mohly Bitcoin začlenit do svých operací. Pro řešení vznikajících složitostí v oblasti účtování kryptoměn budou zásadní pokračující aktualizace a mezinárodní harmonizace.

### Klasifikace bitcoinů v účetní závěrce

Klasifikace bitcoinu v účetní závěrce se liší podle jurisdikce a závisí na jeho zamýšleném použití v rámci podniku. Obecně se s bitcoinem zachází jako s digitálním aktivem, které je podobné zásobám, investicím nebo měně, ale má jedinečné vlastnosti, které ovlivňují jeho účetní zacházení.


- Digitální nebo nehmotný majetek**: Mnoho jurisdikcí, včetně Francie a Evropské unie, klasifikuje bitcoin jako digitální nebo nehmotné aktivum, nikoli jako zákonné platidlo. Tato klasifikace vyžaduje, aby podniky účtovaly o bitcoinech jinak než o fiat měnách.
- Inventář**: Pokud hlavní činnost podniku zahrnuje obchodování s bitcoiny, jako jsou burzy kryptoměn nebo makléři, jsou bitcoiny klasifikovány jako zásoby. V takovém případě se ocenění řídí účetními standardy pro zásoby.
- Finanční investice**: Společnosti, které drží bitcoin jako dlouhodobé aktivum, jej mohou klasifikovat jako finanční investici. Například ve Spojených státech by podniky mohly Bitcoin účtovat podle směrnic Rady pro finanční účetní standardy (FASB) a při poklesu tržní hodnoty vykazovat snížení hodnoty.

**Důsledky klasifikace :**


- Dlouhodobá držba často vyžaduje testování na snížení hodnoty a odpisy.
- Aktivní obchodování nebo činnosti související s platbami vyžadují neustálé sledování realizovaných a nerealizovaných zisků a ztrát.

### Metody oceňování

Metody oceňování jsou účetní techniky používané k určení pořizovací ceny bitcoinů, která je nezbytná pro přesný výpočet zisků nebo ztrát při transakcích. Obecně platí, že nejlepší je **udržovat v účetním systému vždy aktualizovanou hodnotu nákladů na aktuální držbu bitcoinů**. To zajišťuje transparentnost, soulad s daňovými předpisy a zabraňuje zaostávání při potřebě provádět výpočty.


- První dovnitř, první ven (FIFO)**: Tato metoda je běžná v jurisdikcích, jako je Austrálie a Indie, a oceňuje bitcoiny na základě nejstarších pořizovacích nákladů. Tato metoda může být poměrně **složitá**, protože může vyžadovat sledování každé frakce bitcoinu zvlášť, když dojde k prodeji.
- Vážené průměrné náklady (WAC)**: Často se upřednostňuje u velkoobjemových transakcí díky své **jednoduchosti**, jak je vidět v zemích, jako jsou Spojené státy.

Důrazně se doporučuje vést podrobný sešit sledující náklady na bitcoiny **od okamžiku, kdy společnost začne nakupovat bitcoiny nebo je přijímat jako platbu**, aby bylo zajištěno přesné a organizované vedení záznamů. Už jen tato úvaha by měla být na prvním místě při výběru softwarového řešení pro přijímání plateb v bitcoinech nebo pro nákup bitcoinů.

### Účtování transakcí v maloobchodě a elektronickém obchodě

Maloobchodníci musí u každé transakce zaznamenat směnný kurz bitcoinu vůči fiatu. Například v mnoha zemích používají podniky pro výpočet DPH směnný kurz v době prodeje.

Podniky musí zajistit, aby nástroje **Platby**, které používají, umožňovaly:


- vygenerovat fakturu s místní fiat částkou (eura, dolary, libry), DPH nebo jinými místními daněmi, ekvivalentem denominovaným v bitcoinech, datem a časem, směnným kurzem bitcoinu a zdrojem směny atd
- exportovat všechny doklady o platbách, minimálně ve formátu .csv, se všemi výše uvedenými informacemi, aby je účetní mohl snadno zpracovat
- v ideálním případě vést evidenci aktualizované hodnoty nákladového základu pro aktuální bitcoiny držené ve státní pokladně

### Výzvy


- Volatilita**: Cena bitcoinu výrazně kolísá, což způsobuje potíže při oceňování držby a předvídání budoucích finančních výsledků.
- Regulační kontrola**: V zemích, jako je Čína, omezuje status bitcoinu jeho použití jako pokladního aktiva.
- Regulační nejistota** : Vývoj regulačního prostředí v oblasti bitcoinu často nechává podniky v nejistotě. Například změny v daňové politice, například v Indii nebo Spojených státech, mohou ze dne na den ovlivnit účetní postupy.
- Rizika špatného řízení** : Nesprávná klasifikace nebo nesledování transakcí s bitcoiny může vést k problémům s dodržováním předpisů, pokutám nebo poškození pověsti.
- Rizika rekvalifikace**: Udržování významné části pokladny společnosti v bitcoinech vystavuje podnik potenciálním ztrátám z poklesu ceny. To může mít vážné důsledky, zejména pokud k takovému poklesu dojde v době splatnosti plateb dodavatelům, zaměstnancům nebo daní. Kromě toho může být majitel společnosti pohnán k odpovědnosti, což může mít za následek pokuty nebo jiné právní problémy, například obvinění ze zneužití majetku společnosti.

## Účetní nástroje a software

<chapterId>e7b31be5-1176-4835-944e-3cba1b7040fa</chapterId>

Když se společnost rozhodne integrovat bitcoin do svého účetnictví, různé nástroje a specializovaný software zjednoduší sběr a zpracování dat. Mezi nejznámější řešení patří [CoinTracker](https://www.cointracker.io/), [Waltio](https://www.waltio.com/), [Cryptio](https://cryptio.co/), [Koinly](https://koinly.io/), [TokenTax](https://tokentax.co/) a [ZenLedger](https://zenledger.io/). Tyto platformy se zaměřují především na čtyři aspekty:


- automatický sběr dat;
- převod těchto dat do formátů kompatibilních s obecnějším účetním softwarem (QuickBooks, Xero, ERP);
...
### Případ užití 1: Maloobchodní prodejna převádějící platby bitcoiny na eura

**Scénář**: Malá pekárna přijímá bitcoiny jako platební metodu, ale okamžitě převádí všechny přijaté bitcoiny na eura, aby se vyhnula volatilitě kryptoměn.

**Příklad**:


- Konverzní kurz bitcoinu**: 1 Bitcoin = 40 000 EUR.
- Transakce 1**: Zákazník zakoupí více druhů pečiva za 20 EUR.
    - Ekvivalent Bitcoinu: (20 / 40 000) = 0,0005 Bitcoinu = 50 000 Satoshis.
    - Konverzní poplatek: 1,5 % (20 € × 0,015) = 0,30 €.
    - Čistý příjem: 20 EUR - 0,30 EUR = 19,70 EUR.
- Transakce 2**: Zákazník si koupí kávu za 5 EUR.
    - Ekvivalent Bitcoinu: (5 / 40 000) = 0,000125 Bitcoinu = 12 500 Satoshis.
    - Konverzní poplatek: 1,5 % (5 × 0,015 €) = 0,075 €.
    - Čistý příjem: 5 € - 0,075 € = 4,93 €.

**Přehled transakcí**:


- Celkové tržby**: 25 EUR.
- Celkové poplatky**: 0,375 €.
- Čistá přijatá částka**: 24 625 EUR.

**Účetní dopady**:


- Zaznamenejte celkové tržby (25 EUR) jako příjmy.
- Odečtěte poplatky za konverzi (0,375 EUR) jako náklad.
- V rozvaze se neobjevují žádné držené bitcoiny, protože všechny částky byly okamžitě převedeny.

### Případ použití 2: Maloobchodní prodejna, která si ponechává 50 % plateb v bitcoinech

**Scénář**: Stejná pekárna se rozhodne ponechat si 50 % plateb v bitcoinech jako pokladní aktivum, zatímco druhých 50 % převede na eura.

**Příklad**:


- Konverzní kurz bitcoinu**: 1 Bitcoin = 40 000 EUR.
- Transakce od zákazníka**: Zákazník zakoupí pečivo za 50 EUR.
    - Ekvivalent Bitcoinu: (50 / 40 000) = 0,00125 Bitcoinu = 125 000 Satoshis.
    - Převod (50%): Bitcoin v hodnotě 25 € = 0,000625 Bitcoin = 62 500 Satoshis.
        - Konverzní poplatek: 1,5 % (25 € × 0,015) = 0,375 €.
        - Čistý příjem v eurech: 25 EUR - 0,375 EUR = 24,625 EUR.
    - Ponecháno v bitcoinech (50 %): 62 500 Satoshis = 0,000625 Bitcoinu.

**Shrnutí**:


- Celkové tržby**: 50 EUR.
- Poplatky**: 0,375 €.
- Čistá přijatá částka**: 24 625 EUR.
- Uchování bitcoinu**: 62 500 Satoshis.

**Účetní dopady**:


- Zaznamenejte celkové tržby (50 EUR) jako příjmy.
- Odečtěte poplatky za konverzi (0,375 EUR) jako náklad.
- Zadržený Bitcoin (62 500 Satoshis) se v rozvaze objevuje jako digitální aktivum.
- Nerealizovaný zisk: pokud je ocenění bitcoinů na konci fiskálního roku vyšší nebo nižší, vznikne nerealizovaný zisk nebo ztráta, která bude uvedena ve finančních poznámkách, ale nebude realizována jako příjem

### Případ použití 3: Profesionální služba uchovávající bitcoiny pro dlouhodobé investice

**Scénář**: Grafik na volné noze přijímá Bitcoiny jako platbu a všechny přijaté Bitcoiny si ponechává jako dlouhodobou investici.

**Příklad**:


- Konverzní kurz bitcoinu při platbě**: 1 Bitcoin = 30 000 EUR.
- Transakce od zákazníka**: Zákazník zaplatí za služby v hodnotě 3 000 EUR.
    - Ekvivalent Bitcoinu: (3 000 / 30 000) = 0,1 Bitcoinu = 10 000 000 Satoshis.
- Ocenění na konci roku**:
    - Konverzní kurz bitcoinu na konci roku: 1 bitcoin = 35 000 EUR.
    - Ocenění držby bitcoinu: 0.1 Bitcoin × 35 000 EUR = 3 500 EUR.
    - Nerealizovaný zisk: 3 500 EUR - 3 000 EUR = 500 EUR.

**Shrnutí**:


- Celkové uznané příjmy**: 3 000 EUR.
- Bitcoin Holding**: 0.1 bitcoin má v rozvaze hodnotu 3 500 EUR.
- Nerealizovaný zisk**: 500 EUR vykázaných ve finančních poznámkách, ale nerealizovaných jako příjem.

**Účetní dopady**:


- Záznam o příjmech (3 000 EUR) v době poskytnutí služby.
- Bitcoin si ponechal (0,1) v hodnotě 3 500 EUR v rozvaze.
- Nerealizované zisky jsou sledovány, ale nejsou zahrnuty do výkazů zisku a ztráty.

### Případ použití 4: Majitel firmy prodá 50 % bitcoinů po zvýšení ceny

**Scénář**: Majitel firmy během roku třikrát nakoupí bitcoiny, drží je jako aktivum a po výrazném zvýšení ceny 50 % prodá.

**Příklad**:


- Nákupy bitcoinů od zákazníků**:
    - Nákup 1: 2 000 € za 20 000 €/BTC = 0,1 Bitcoinu = 10 000 000 Satoshis.
    - Nákup 2: 3 000 € za 25 000 €/BTC = 0,12 Bitcoin = 12 000 000 Satoshis.
    - Nákup 3: 5 000 € za 30 000 €/BTC = 0,1667 Bitcoinu = 16 670 000 Satoshis.
    - Celkový počet držených bitcoinů**: 0.3867 Bitcoinů = 38 670 000 Satoshis.
- Ocenění na konci roku**:
    - Cena bitcoinu na konci roku: 40 000 €/BTC.
    - Celková hodnota: 0,3867 Bitcoinu × 40 000 € = 15 468 €.
    - Nerealizovaný zisk: 15 468 EUR - 10 000 EUR (celkové náklady) = 5 468 EUR.
- Prodej 50 % Bitcoinu**:
    - Prodaný bitcoin: 0.19335 Bitcoin.
    - Výnosy z prodeje: 0.19335 Bitcoin × 40 000 € = 7 734 €.
    - Nákladový základ (vážený průměr):
        - Celkové náklady: 2 000 € + 3 000 € + 5 000 € = 10 000 €.
        - Vážená průměrná cena: 10 000 € / 0,3867 Bitcoin = 25 850 €/BTC.
        - Cena prodaných bitcoinů: 0,19335 bitcoinu × 25 850 € = 4 999 €.
    - Realizovaný zisk: 7 734 EUR - 4 999 EUR = 2 735 EUR.

**Shrnutí**:


- Zbývající bitcoiny**: 0.19335 Bitcoinů v hodnotě 7 734 € (při ceně 40 000 €/BTC).
- Realizovaný zisk**: 2 735 EUR zahrnutý do výkazu zisku a ztráty.
- Nerealizovaný zisk**: 5 468 EUR zveřejněný ve finančních poznámkách (včetně nerealizované hodnoty zbývajících bitcoinů).

**Účetní dopady**:


- Výnosy z prodeje (7 734 EUR) zaúčtujte jako příjem.
- Pro výpočet realizovaného zisku odečtěte cenu prodaných bitcoinů (4 999 EUR).
