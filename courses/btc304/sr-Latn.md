...
Njegov razvoj je takođe evidentan na on-chainu, sa stalnim porastom broja transakcija.


Na primer, između 1. januara 2018. i 1. januara 2024. godine, procenjuje se da je broj transakcija na glavnom Bitcoin sloju [porastao za 66,2%](https://dune.com/queries/3375917/5663935). U međuvremenu, između avgusta 2021. i avgusta 2023. godine, broj javnih transakcija na Lightning Network-u [porastao je za 1.212%](https://river.com/learn/files/river-lightning-report-2023.pdf).
...
- Kako možemo podstaći Bitcoin entuzijaste da idu dalje u svom učenju i projektima kako bi **u potpunosti iskoristili potencijal Bitcoina**?



- Kako možemo pomoći novajlijama, koje često privlači kratkoročna spekulacija, da izbegnu gubitak novca na najnovijoj memecoin pomami i umesto toga se fokusiraju na **učenje osnova Bitcoina**?
...
Počećemo isticanjem važnosti ujedinjavanja ljudi oko Bitcoina, bilo putem online zajednica ili lokalnih okupljanja. Otkrićete zašto i gde pokrenuti svoju zajednicu, kao i kako postaviti jasne ciljeve za podsticanje njenog rasta i dugoročne održivosti.



**Sekcija 2: Dizajniranje jedinstvenog identiteta vaše Bitcoin zajednice**
...
**Sekcija 4: Pokretanje vaših društvenih mreža** (na francuskom)
...
**Sekcija 5: Organizovanje Bitcoin okupljanja**
...
**Sekcija 6: Primeri projekata i inicijativa** (na francuskom)
...
**Sekcija 8: Okupljanje bitkoinera**


Završni deo se fokusira na suštinu vašeg projekta: ujedinjenje Bitcoin entuzijasta oko zajedničke vizije. Naučićete kako da strukturirate svoj pristup kako biste privukli i zadržali članove, efikasno delegirali zadatke i održivo razvijali svoju zajednicu.
...
Iako ne postoji stroga definicija ovih pojmova u Bitcoin ekosistemu, zajednica se najbolje razume kao grupa ljudi koji dele zajedničku strast i redovno komuniciraju.
...
### Zašto kreirati Bitcoin zajednicu?



Postoji nekoliko razloga za stvaranje Bitcoin zajednice:



- Deljenje znanja i saradnja: zajednice pružaju članovima prostor za razmenu ideje i deljenje znanja. Uzajamna podrška je ključni stub za rast, omogućavajući svima da ubrzaju svoje učenje, što je posebno relevantno za Bitcoin, s obzirom na to koliko toga ima za otkriti.



- Peer-to-peer saradnja i razvoj: mnoge inicijative i projekti su osmišljeni, izgrađeni i razvijeni unutar ovih zajednica.



Bitcoin zajednice često teže širim ciljevima, posebno javnom obrazovanju o:
...
5. Osnovne razlike između Bitcoina i drugih [kripto-valuta](https://planb.academy/resources/glossary/cryptocurrency);


Izgradnjom prvih "citadela" sutrašnjice, **Bitcoin zajednice širom sveta služe kao bedem protiv dezinformacija i cenzure, dok istovremeno pružaju plodno tlo za učenje osnova Bitcoina**. One nude novajlijama, pa čak i skepticima, resurse i veze potrebne za istraživanje pravog potencijala Bitcoina.
...
Kako se putovanje bitkoinera razvija, često se javlja želja, ili čak potreba, **da se lično sretnu i komuniciraju sa drugima** iz istog ekosistema. Ovo može proizaći iz osećaja izolacije ili jednostavno iz nedostatka nekoga s kim bi se razgovaralo o Bitcoinu u svakodnevnom životu.


Meetupi nude ličnije i prijatnije iskustvo nego onlajn audio ili video pozivi. Bilo **uz piće ili obrok**, oni stvaraju neformalne, prijateljske prostore gde ljudi mogu razmenjivati ideje otvoreno i direktno.
...
- Diskusije o tehničkim temama ili tekućim projektima
- Pomaganje novim bitkoinerima da postepeno dublje zarone u Bitcoin svet
...
1/ **Kreirajte i razvijajte svoju zajednicu u srednjem ili velikom gradu**. Ovo će olakšati:
    ...
    - pronalaženje prijatnih prostora za okupljanja i projekte (prezentacije, radionice, promocija usvajanja Bitcoina, itd.);
    - povećanje osećaja uključenosti i pripadnosti kod većeg broja ljudi;
    - poboljšanje pristupačnosti događaja (javni prevoz, parking, itd.). Preporučuje se odabir lokacije blizu javnog prevoza i parkinga.
...
I naravno, ako se starija zajednica "evoluirala" u pravcu koji više ne odgovara vašim vrednostima, a nemate vremena ili motivacije da ih "[orange-pillujete](https://planb.academy/resources/glossary/orange-pill)", onda je stvaranje sopstvenog [forka](https://planb.academy/resources/glossary/fork) uvek opcija.
...
Ako je vaš cilj da **delite znanje i edukujete ljude o Bitcoinu**, fokusirajte se na **kreiranje edukativnog sadržaja** (članci, podcasti, video materijali, prezentacije, flajeri, itd.), štedeći drugima bezbroj sati istraživanja. Možete ići i dalje tako što ćete **organizovati radionice, prezentacije i konferencije**.
...
- kombinovanje umrežavanje sa edukativnom prezentacijom o Bitcoin konceptu;
- organizovanje profesionalnih demonstracija Bitcoin rešenja;
- razmatranje strategija za „orange-pilling“ lokalnih trgovaca;
...
- sarađujte sa postojećim zajednicama radi pristupa širim informacijama, resursima otvorenog koda i dragocenoj podršci kada je to potrebno.
...
- Srednjoročno: sprovesti kampanje za podizanje svesti ili edukaciju o Bitcoinu
...
# Dizajniranje identiteta Bitcoin zajednice 
...
- U Monaku, logo prikazuje monaški kamen (Monegasque rock):
...
- U Saint-Malo-u, ističe se ermine – grb grada:
...
Možete dodati lokalnu znamenitost ili amblem u pozadinu (uvezite fotografiju ili pretražite "Ilustracije" (eng. Illustrations) ili "Slike"  (eng. Images) u meniju Elements), zatim preklopite Bitcoin logo ili ₿, prilagođavajući njegovu boju po potrebi.
...
Takođe možete koristiti meni Dizajni (eng. Designs) da istražite dodatne modele koji odgovaraju vašim potrebama.


Za YouTube sličice ili banere, jednostavno potražite te šablone, duplirajte ih i prilagodite po želji.
...
- **letak** "21 razloga za korišćenje Bitcoina", napisao @ProfEduStream: [link](https://www.canva.com/design/DAFtAR1NauQ/ZDwl2CchIJ9Gpb36N6-7iw/edit?utm_content=DAFtAR1NauQ&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)
...
| Platforma | Logo | Baner | Poster / Slika
| -------- | -------- | -------- | -------- |
...
- Twitter (X): glavna društvena mreža koju koriste bitkoineri širom sveta. Koristi je ~70% francuskih okupljanja. Idealna je za dopiranje do bitkoinera.
...
Ako je potrebno, kasnije grupu možete pretvoriti u supergrupu.
...
Zaista, **Telegram kanal više funkcioniše kao alat za jednostrano emitovanje poruka od strane administratora**. Članovi ne mogu slobodno da ćaskaju, mogu samo da reaguju sa emotikonima (ili da ostavljaju komentare u posebnim nitima (eng. threads), što fragmentira razgovore).
...
- objaviti i zakačiti važne poruke.
- kreirati **ankete** (korisno za odlučivanje o datumima sastanaka kada je vaša zajednica nova).
- kreirati **prilagođeni pozivni link** (samo ako je grupa "javna" a ne "privatna", što je definisano u podešavanjima. Takođe je korisno imati svoj Telegram pozivni link, kao što je: t.me/Bitcoin[CITY]);
- upravljati dozvolama članova, ulogama i moderacijom.
- dadati profilnu sliku (logo vaše zajednice) i ažurirarati ime grupe.
...
1. **prikačite važne poruke** kako bi svi članovi dobili obaveštenje (pritisnite jednom prstom na poruku o kojoj je reč, zatim izaberite "Prikači" (eng. Pin));
...
- "Vašne informacije": samo ključne novosti i najave događaja.
...
Ne postoji strogo pravilo kada treba preći sa obične Telegram grupe na supergrupu, to zaista zavisi od potreba vaših članova. Dobra vest je da možete lako prelaziti napred-nazad: jednostavno kreirajte temu da biste grupu pretvorili u supergrupu, ili obrišite sve teme osim „General“ da se vratite na običnu grupu.
...
Samo kreirajte Telegram grupu, idite na njena podešavanja i dodirnite dugme "Topics" da dodate teme. Kada sačuvate, videćete listu tema koje možete uređivati kako želite.
...
U zavisnosti od vaših potreba i dobavljača, 1.000 nalepnica može koštati između 100€ i 250€. Možete kontaktirati [@Mill3sim3 na Twitteru](https://x.com/Mill3sim3), francuskog bitkoinera specijalizovanog za marketing, koji ponekad može obezbediti cene do 30% niže od standardnih online prodavaca.
