...
| Application          | E2EE 1:1       | E2EE grupe   | Inscription anonyme | Licenca otvorenog koda klijenta | Licenca otvorenog koda servera | Decentralizovan server | Godina kreiranja |
| -------------------- | -------------- | -------------- | ------------------- | -------------------------- | --------------------------- | -------------------- | ----------------- |
| WhatsApp             | ✅              | ✅              | ❌                   | ❌                          | ❌                           | ❌                    | 2009              |
| WeChat               | ❌              | ❌              | ❌                   | ❌                          | ❌                           | ❌                    | 2011              |
